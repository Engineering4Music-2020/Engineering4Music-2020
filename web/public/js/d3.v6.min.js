...
!(function (t, n) {
	...
	function k() {
		...
		function r(r) {
			...
			var f = n(c),
				...
				l = f[1],
				h = e(c, s, l);
			Array.isArray(h) || ((h = A(s, l, h))[h.length - 1] === l && h.pop());
			for (var d = h.length; h[0] <= s; ) h.shift(), --d;
			for (; h[d - 1] > l; ) h.pop(), --d;
			var p,
				g = new Array(d + 1);
			for (i = 0; i <= d; ++i)
				((p = g[i] = []).x0 = i > 0 ? h[i - 1] : s), (p.x1 = i < d ? h[i] : l);
			for (i = 0; i < u; ++i)
				s <= (a = c[i]) && a <= l && g[o(h, a, 0, d)].push(r[i]);
			return g;
		}
		return (
			(r.value = function (n) {
	...
	function P(t, e, r = 0, i = t.length - 1, o = n) {
		for (; i > r; ) {
			if (i - r > 600) {
				const n = i - r + 1,
					a = e - r + 1,
			...
			let a = r,
				u = i;
			for (z(t, r, e), o(t[i], n) > 0 && z(t, r, i); a < u; ) {
				for (z(t, a, u), ++a, --u; o(t[a], n) < 0; ) ++a;
				for (; o(t[u], n) > 0; ) --u;
			}
			0 === o(t[r], n) ? z(t, r, u) : (++u, z(t, u, i)),
				u <= e && (r = u + 1),
				e <= u && (i = u - 1);
		}
		return t;
	...
	function D(t, n, e) {
		if (
			...
			if ((n = +n) <= 0 || r < 2) return C(t);
			if (n >= 1) return N(t);
			var r,
				i = (r - 1) * n,
				o = Math.floor(i),
				a = N(P(t, o).subarray(0, o + 1));
			return a + (C(t.subarray(o + 1)) - a) * (i - o);
		}
	}
	function q(t, n) {
		let e,
	...
	function L(t) {
		...
		for (var n = -1, e = C(t, j), r = new Array(e); ++n < e; )
		...
		function l(l) {
			...
			(m = m.merge(
				...
				l !== b &&
					...
					M.attr("opacity", G).attr("transform", function (t) {
	...
	function it(t, n, e) {
		for (var r = 0, i = t.length; r < i; ++r)
			if (t[r].name === n) {
				(t[r] = J), (t = t.slice(0, r).concat(t.slice(r + 1)));
				break;
			}
	...
	nt.prototype = tt.prototype = {
		...
		on: function (t, n) {
			...
			if (!(arguments.length < 2)) {
				...
				for (; ++o < a; )
					if ((e = (t = i[o]).type)) r[e] = it(r[e], t.name, n);
					else if (null == n) for (e in r) r[e] = it(r[e], t.name, null);
				return this;
			}
			for (; ++o < a; )
				if ((e = (t = i[o]).type) && (e = rt(r[e], t.name))) return e;
		},
		copy: function () {
			var t = {},
				n = this._;
	...
	var _t = Array.prototype.find;
	function bt() {
		return this.firstElementChild;
	}
	var mt = Array.prototype.filter;
	function xt() {
	...
	function It(t, n) {
		return (
			...
			Rt(t).getComputedStyle(t, null).getPropertyValue(n)
		);
	}
	function Bt(t) {
		return function () {
	...
	function Zt(t, n) {
		return function () {
			(n.apply(this, arguments) ? Gt : Vt)(this, t);
		};
	}
	function Kt() {
		this.textContent = "";
	...
	function _n() {
		return new vn([[document.documentElement]], yn);
	}
	function bn(t) {
	...
	vn.prototype = _n.prototype = {
		...
		selectChild: function (t) {
			return this.select(
				null == t
					...
					: (function (t) {
							return function () {
								return _t.call(this.children, t);
							};
		...
		data: function (t, n) {
			...
			for (
				...
				var s = r[f],
					l = i[f],
					h = l.length,
					d = dt(t.call(s, s && s.__data__, f, r)),
					p = d.length,
					g = (u[f] = new Array(p)),
					y = (a[f] = new Array(p)),
					v = (c[f] = new Array(h));
		...
		enter: function () {
			return new vn(this._enter || this._groups.map(wt), this._parents);
		},
		exit: function () {
			return new vn(this._exit || this._groups.map(wt), this._parents);
		},
		join: function (t, n, e) {
			var r = this.enter(),
				i = this,
		...
		merge: function (t) {
			if (!(t instanceof vn)) throw new Error("invalid merge");
			for (
				var n = this._groups,
					e = t._groups,
					r = n.length,
		...
		style: function (t, n, e) {
			return arguments.length > 1
				? this.each(
						(null == n ? Ft : "function" == typeof n ? Ot : Ut)(
							t,
							n,
							null == e ? "" : e
						)
		...
		property: function (t, n) {
			return arguments.length > 1
				? this.each((null == n ? Bt : "function" == typeof n ? Lt : Yt)(t, n))
				: this.node()[t];
		},
		classed: function (t, n) {
			var e = jt(t + "");
			if (arguments.length < 2) {
				for (var r = Ht(this.node()), i = -1, o = e.length; ++i < o; )
		...
		html: function (t) {
			return arguments.length
				? this.each(null == t ? tn : ("function" == typeof t ? en : nn)(t))
				: this.node().innerHTML;
		},
		raise: function () {
			return this.each(rn);
		...
		insert: function (t, n) {
			var e = "function" == typeof t ? t : st(t),
				r = null == n ? an : "function" == typeof n ? n : ht(n);
			return this.select(function () {
		...
		on: function (t, n, e) {
			var r,
				...
				a = o.length;
			if (!(arguments.length < 2)) {
				for (u = n ? hn : ln, r = 0; r < a; ++r) this.each(u(o[r], n, e));
				return this;
			}
		...
		dispatch: function (t, n) {
			return this.each(("function" == typeof n ? gn : pn)(t, n));
		},
	...
	function En(t) {
		var n = t.document.documentElement,
			e = bn(t).on("dragstart.drag", Sn, !0);
		"onselectstart" in n
			? e.on("selectstart.drag", Sn, !0)
	...
	var On = 0.7,
		...
		Ln = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
		jn = /^#([0-9a-f]{3,8})$/,
		Hn = new RegExp("^rgb\\(" + [Bn, Bn, Bn] + "\\)$"),
		Xn = new RegExp("^rgb\\(" + [Ln, Ln, Ln] + "\\)$"),
		Gn = new RegExp("^rgba\\(" + [Bn, Bn, Bn, Yn] + "\\)$"),
		Vn = new RegExp("^rgba\\(" + [Ln, Ln, Ln, Yn] + "\\)$"),
		$n = new RegExp("^hsl\\(" + [Yn, Ln, Ln] + "\\)$"),
		Wn = new RegExp("^hsla\\(" + [Yn, Ln, Ln, Yn] + "\\)$"),
		Zn = {
			aliceblue: 15792383,
			...
			(n = jn.exec(t))
				? ((e = n[1].length),
				  ...
				  6 === e
						...
						: null)
				: (n = Hn.exec(t))
				? new ie(n[1], n[2], n[3], 1)
				: (n = Xn.exec(t))
				? new ie((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
				: (n = Gn.exec(t))
				? ne(n[1], n[2], n[3], n[4])
				: (n = Vn.exec(t))
				? ne((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
				: (n = $n.exec(t))
	...
	function te(t) {
		return new ie((t >> 16) & 255, (t >> 8) & 255, 255 & t, 1);
	}
	function ne(t, n, e, r) {
		return r <= 0 && (t = n = e = NaN), new ie(t, n, e, r);
	}
	function ee(t) {
		return (
			t instanceof Un || (t = Jn(t)),
			t ? new ie((t = t.rgb()).r, t.g, t.b, t.opacity) : new ie()
		);
	}
	function re(t, n, e, r) {
		return 1 === arguments.length ? ee(t) : new ie(t, n, e, null == r ? 1 : r);
	}
	function ie(t, n, e, r) {
	...
	function fe(t) {
		...
		if ((t instanceof Un || (t = Jn(t)), !t)) return new le();
	...
	Rn(Un, Jn, {
		...
		Rn(
			...
			Fn(Un, {
				brighter: function (t) {
					return (
						(t = null == t ? In : Math.pow(In, t)),
						new ie(this.r * t, this.g * t, this.b * t, this.opacity)
					);
				},
				darker: function (t) {
					return (
						(t = null == t ? On : Math.pow(On, t)),
						new ie(this.r * t, this.g * t, this.b * t, this.opacity)
					);
				},
				rgb: function () {
	...
	function me(t) {
		...
		if (t instanceof Ne) return Ce(t);
		t instanceof ie || (t = ee(t));
		var n,
			e,
			r = Se(t.r),
			i = Se(t.g),
		...
		return (
			r === i && i === o
				? (n = e = a)
				: ((n = Me((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / ge)),
				  (e = Me((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / ye))),
			new we(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
		);
	}
	function xe(t, n, e, r) {
		return 1 === arguments.length ? me(t) : new we(t, n, e, null == r ? 1 : r);
	}
	function we(t, n, e, r) {
		(this.l = +t), (this.a = +n), (this.b = +e), (this.opacity = +r);
	}
	function Me(t) {
		return t > 0.008856451679035631 ? Math.pow(t, 1 / 3) : t / be + ve;
	}
	function Ae(t) {
		return t > _e ? t * t * t : be * (t - ve);
	}
	function Te(t) {
		return (
	...
	function Ee(t) {
		if (t instanceof Ne) return new Ne(t.h, t.c, t.l, t.opacity);
		if ((t instanceof we || (t = me(t)), 0 === t.a && 0 === t.b))
			return new Ne(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
		var n = Math.atan2(t.b, t.a) * pe;
		return new Ne(
			n < 0 ? n + 360 : n,
	...
	function ke(t, n, e, r) {
		return 1 === arguments.length ? Ee(t) : new Ne(t, n, e, null == r ? 1 : r);
	}
	function Ne(t, n, e, r) {
	...
	function Ie(t) {
		...
		var n = t.r / 255,
			e = t.g / 255,
			r = t.b / 255,
			i = (Oe * r + Fe * n - Ue * e) / (Oe + Fe - Ue),
			o = r - i,
			a = (Re * (e - i) - De * o) / qe,
			u = Math.sqrt(a * a + o * o) / (Re * i * (1 - i)),
			c = u ? Math.atan2(a, o) * pe - 120 : NaN;
		return new Ye(c < 0 ? c + 360 : c, u, i, t.opacity);
	}
	function Be(t, n, e, r) {
		return 1 === arguments.length ? Ie(t) : new Ye(t, n, e, null == r ? 1 : r);
	}
	function Ye(t, n, e, r) {
		(this.h = +t), (this.s = +n), (this.l = +e), (this.opacity = +r);
	}
	...
	Rn(
		...
		Fn(Un, {
			brighter: function (t) {
				return (
					(t = null == t ? In : Math.pow(In, t)),
					new Ye(this.h, this.s, this.l * t, this.opacity)
				);
			},
			darker: function (t) {
				return (
			...
			rgb: function () {
				var t = isNaN(this.h) ? 0 : (this.h + 120) * de,
					n = +this.l,
	...
	function Ve(t, n) {
		var e = n - t;
		return e
			? Ge(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
			: Xe(isNaN(t) ? n : t);
	}
	function $e(t) {
		return 1 == (t = +t)
	...
	function Ke(t) {
		return function (n) {
			var e,
				...
				u = new Array(i);
			for (e = 0; e < i; ++e)
				(r = re(n[e])), (o[e] = r.r || 0), (a[e] = r.g || 0), (u[e] = r.b || 0);
			return (
				(o = t(o)),
				(a = t(a)),
				(u = t(u)),
	...
	var ar = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
		ur = new RegExp(ar.source, "g");
	function cr(t, n) {
		var e,
			r,
			i,
			o = (ar.lastIndex = ur.lastIndex = 0),
			a = -1,
			u = [],
			c = [];
		for (t += "", n += ""; (e = ar.exec(t)) && (r = ur.exec(n)); )
			(i = r.index) > o &&
	...
	function pr(t, n, e, r, i, o) {
		...
		return (
			...
			t * r < n * e && ((t = -t), (n = -n), (c = -c), (a = -a)),
			{
				translateX: i,
				translateY: o,
				rotate: Math.atan2(n, t) * hr,
				skewX: Math.atan(c) * hr,
				scaleX: a,
				scaleY: u,
			}
		);
	...
	var yr = gr(
			function (t) {
				const n = new ("function" == typeof DOMMatrix
					? DOMMatrix
					: WebKitCSSMatrix)(t + "");
				return n.isIdentity ? dr : pr(n.a, n.b, n.c, n.d, n.e, n.f);
			},
			"px, ",
			"px)",
			"deg)"
		...
		vr = gr(
			function (t) {
				return null == t
					? dr
					: (lr ||
							(lr = document.createElementNS(
								"http://www.w3.org/2000/svg",
								"g"
							)),
					  lr.setAttribute("transform", t),
					  (t = lr.transform.baseVal.consolidate())
							? pr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
							: dr);
			},
			", ",
			")",
			...
			if (g < 1e-12)
				...
				(a = (m - b) / n),
					(o = function (t) {
						...
						return [u + o * d, c + o * p, (f * i) / _r(n * r + b)];
					});
			}
	...
	function mr(t) {
		return function (n, e) {
			var r = t((n = se(n)).h, (e = se(e)).h),
				i = We(n.s, e.s),
				o = We(n.l, e.l),
				a = We(n.opacity, e.opacity);
			return function (t) {
				return (
	...
	function Sr(t) {
		return (function n(e) {
			function r(n, r) {
				var i = t((n = Be(n)).h, (r = Be(r)).h),
					o = We(n.s, r.s),
					a = We(n.l, r.l),
					u = We(n.opacity, r.opacity);
				return function (t) {
					return (
						(n.h = i(t)),
						(n.s = o(t)),
	...
	function Hr() {
		Br(), ++zr;
		for (var t, n = Cr; n; )
			(t = Fr - n._time) >= 0 && n._call.call(null, t), (n = n._next);
		--zr;
	}
	function Xr() {
		(Fr = (Rr = Or.now()) + Ur), (zr = Dr = 0);
		try {
			Hr();
		} finally {
			(zr = 0),
	...
	function Vr(t) {
		zr ||
			...
			t - Fr > 24
				? (t < 1 / 0 && (Dr = setTimeout(Xr, t - Or.now() - Ur)),
				  qr && (qr = clearInterval(qr)))
				: (qr || ((Rr = Or.now()), (qr = setInterval(Gr, 1e3))),
				  (zr = 1),
				  Ir(Xr)));
	}
	function $r(t, n, e) {
	...
	Lr.prototype = jr.prototype = {
		constructor: Lr,
		restart: function (t, n, e) {
			if ("function" != typeof t)
				throw new TypeError("callback is not a function");
			(e = (null == e ? Br() : +e) + (null == n ? 0 : +n)),
				this._next ||
					Pr === this ||
					(Pr ? (Pr._next = this) : (Cr = this), (Pr = this)),
				(this._call = t),
				(this._time = e),
				Vr();
		},
	...
	var Wr = tt("start", "end", "cancel", "interrupt"),
		Zr = [];
	...
	var wi = _n.prototype.constructor;
	function Mi(t) {
		return function () {
			this.style.removeProperty(t);
		};
	...
	Ni.prototype = Ci.prototype = {
				...
				for (var c, f = r[u], s = f.length, l = 0; l < s; ++l)
					if ((c = f[l])) {
						for (
							...
							(h = d[g]) && Kr(h, n, e, g, d, p);
						o.push(d), a.push(c);
					}
			return new Ni(o, a, n, e);
		},
		filter: function (t) {
			"function" != typeof t && (t = yt(t));
			for (
		...
		merge: function (t) {
			...
			for (
				...
				for (
					...
					(c = f[d] || s[d]) && (h[d] = c);
			for (; u < r; ++u) a[u] = n[u];
			return new Ni(a, this._parents, this._name, this._id);
		},
		selection: function () {
		...
		attr: function (t, n) {
			...
			return this.attrTween(
				t,
				"function" == typeof n
					? (e.local ? li : si)(e, r, ii(this, "attr." + t, n))
					: null == n
					? (e.local ? ui : ai)(e)
					: (e.local ? fi : ci)(e, r, n)
			);
		...
		attrTween: function (t, n) {
			...
			if ("function" != typeof n) throw new Error();
			var r = ut(t);
			return this.tween(e, (r.local ? pi : gi)(r, n));
		},
		style: function (t, n, e) {
			var r = "transform" == (t += "") ? yr : oi;
			return null == n
				? this.styleTween(
						t,
						(function (t, n) {
				...
				? this.styleTween(
						...
						(function (t, n, e) {
							...
							return function () {
								...
								return (
									null == u &&
										(this.style.removeProperty(t), (c = u = It(this, t))),
									a === c
										? null
										: a === r && c === i
										? o
		...
		styleTween: function (t, n, e) {
			...
			if ("function" != typeof n) throw new Error();
			return this.tween(r, Ti(t, n, null == e ? "" : e));
		},
		text: function (t) {
			return this.tween(
				"text",
		...
		tween: function (t, n) {
			...
			if (((t += ""), arguments.length < 2)) {
				for (
					var r, i = ti(this.node(), e).tween, o = 0, a = i.length;
					o < a;
					++o
				)
			...
			return this.each((null == n ? ei : ri)(e, t, n));
		},
		delay: function (t) {
			var n = this._id;
			return arguments.length
				? this.each(("function" == typeof t ? yi : vi)(n, t))
				: ti(this.node(), n).delay;
		},
		duration: function (t) {
			var n = this._id;
			return arguments.length
				? this.each(("function" == typeof t ? _i : bi)(n, t))
				: ti(this.node(), n).duration;
		},
		ease: function (t) {
			var n = this._id;
			return arguments.length ? this.each(mi(n, t)) : ti(this.node(), n).ease;
		},
	...
	var Ri = (function t(n) {
		...
		Ii = Oi / 2;
	function Bi(t) {
		return (1 - Math.cos(Oi * t)) / 2;
	}
	function Yi(t) {
		return 1.0009775171065494 * (Math.pow(2, -10 * t) - 0.0009765625);
	}
	function Li(t) {
		return ((t *= 2) <= 1 ? Yi(1 - t) : 2 - Yi(t - 1)) / 2;
	}
	function ji(t) {
		return (
			((t *= 2) <= 1
	...
	function Gi(t) {
		return (t = +t) < Hi
			...
			? Xi * (t -= 0.5454545454545454) * t + 0.75
			: t < 0.9090909090909091
			? Xi * (t -= 0.8181818181818182) * t + 0.9375
			: Xi * (t -= 0.9545454545454546) * t + 0.984375;
	}
	var Vi = 1.70158,
		$i = (function t(n) {
			function e(t) {
		...
		Ki = 2 * Math.PI,
		Qi = (function t(n, e) {
			var r = Math.asin(1 / (n = Math.max(1, n))) * (e /= Ki);
			function i(t) {
				return n * Yi(-(--t)) * Math.sin((r - t) / e);
			}
			return (
		...
		Ji = (function t(n, e) {
			var r = Math.asin(1 / (n = Math.max(1, n))) * (e /= Ki);
			function i(t) {
				return 1 - n * Yi((t = +t)) * Math.sin((t + r) / e);
			}
			return (
				(i.amplitude = function (n) {
					return t(n, e * Ki);
		...
		to = (function t(n, e) {
			...
			function i(t) {
				return (
					((t = 2 * t - 1) < 0
						? n * Yi(-t) * Math.sin((r - t) / e)
						: 2 - n * Yi(t) * Math.sin((r + t) / e)) / 2
				);
			}
			return (
				(i.amplitude = function (n) {
		...
		no = { time: null, delay: 0, duration: 250, ease: qi };
	function eo(t, n) {
		for (var e; !(e = t.__transition) || !(e = e[n]); )
			if (!(t = t.parentNode)) throw new Error(`transition ${n} not found`);
		return e;
	}
	(_n.prototype.interrupt = function (t) {
		return this.each(function () {
			ni(this, t);
		});
	}),
		(_n.prototype.transition = function (t) {
			var n, e;
			t instanceof Ni
				? ((n = t._id), (t = t._name))
				: ((n = Pi()), ((e = no).time = Br()), (t = null == t ? null : t + ""));
			for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
				for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)
					(a = u[f]) && Kr(a, t, n, f, u, e || eo(a, n));
	...
	var co = { name: "drag" },
		...
		so = { name: "handle" },
		lo = { name: "center" };
	const { abs: ho, max: po, min: go } = Math;
	function yo(t) {
		return [+t[0], +t[1]];
	}
	function vo(t) {
		return [yo(t[0]), yo(t[1])];
	}
	var _o = {
			name: "x",
			handles: ["w", "e"].map(So),
		...
		mo = {
			name: "xy",
			handles: ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(So),
			input: function (t) {
		...
		wo = { e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se" },
	...
	function zo(t) {
		...
		function c(n) {
			...
			e
				...
				.attr("cursor", xo.overlay)
				.merge(e)
				.each(function () {
					var t = Co(this).extent;
					bn(this)
						.attr("x", t[0][0])
						.attr("y", t[0][1])
		...
		function h(e) {
			if ((!n || e.touches) && r.apply(this, arguments)) {
				var i,
					...
					D = Array.from(e.touches || [e], (t) => {
						...
						return ((t = An(t, _)).point0 = t.slice()), (t.identifier = n), t;
					});
				if ("overlay" === b) {
					T && (g = !0);
					const n = [D[0], D[1] || D[0]];
					(M.selection = T = [
						[
							(i = t === bo ? S : go(n[0][0], n[1][0])),
							(u = t === _o ? E : go(n[0][1], n[1][1])),
						],
						[
							(l = t === bo ? k : po(n[0][0], n[1][0])),
							(d = t === _o ? N : po(n[0][1], n[1][1])),
						],
					]),
						D.length > 1 && I();
				} else (i = T[0][0]), (u = T[0][1]), (l = T[1][0]), (d = T[1][1]);
				(a = i), (c = u), (h = l), (p = d);
				var q = bn(_).attr("pointer-events", "none"),
					R = q.selectAll(".overlay").attr("cursor", xo[b]);
				ni(_);
				...
				if (e.touches) (F.moved = O), (F.ended = B);
					...
					o && U.on("keydown.brush", Y, !0).on("keyup.brush", L, !0),
						En(e.view);
				}
			...
			function O(t) {
				for (const n of t.changedTouches || [t])
					for (const t of D)
						t.identifier === n.identifier && (t.cur = An(n, _));
				if (z && !y && !v && 1 === D.length) {
					const t = D[0];
					ho(t.cur[0] - t[0]) > ho(t.cur[1] - t[1]) ? (v = !0) : (y = !0);
				}
			...
			function I(t) {
				...
				switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
					case fo:
					case co:
						x && ((C = po(S - i, go(k - l, C))), (a = i + C), (h = l + C)),
							w && ((P = po(E - u, go(N - d, P))), (c = u + P), (p = d + P));
						break;
					case so:
						D[1]
							? (x &&
							  ...
							  w &&
									...
									(w = 1)))
							: (x < 0
									? ((C = po(S - i, go(k - i, C))), (a = i + C), (h = l))
									: x > 0 &&
									  ((C = po(S - l, go(k - l, C))), (a = i), (h = l + C)),
							  w < 0
									? ((P = po(E - u, go(N - u, P))), (c = u + P), (p = d))
									: w > 0 &&
									  ((P = po(E - d, go(N - d, P))), (c = u), (p = d + P)));
						break;
					case lo:
						x && ((a = po(S, go(k, i - C * x))), (h = po(S, go(k, l + C * x)))),
							w &&
								((c = po(E, go(N, u - P * w))), (p = po(E, go(N, d + P * w))));
				}
				h < a &&
					((x *= -1),
					(r = i),
					...
					(a = h),
					(h = r),
					b in wo && R.attr("cursor", xo[(b = wo[b])])),
					p < c &&
						((w *= -1),
						(r = u),
						(u = d),
						...
						(c = p),
						(p = r),
						b in Mo && R.attr("cursor", xo[(b = Mo[b])])),
			...
			function B(t) {
				...
				q.attr("pointer-events", "all"),
					R.attr("cursor", xo.overlay),
					M.selection && (T = M.selection),
					Po(T) && ((M.selection = null), f.call(_)),
					F.end(t, m.name);
			}
			function Y(t) {
				switch (t.keyCode) {
		...
		function g() {
			...
			return (n.extent = vo(e.apply(this, arguments))), (n.dim = t), n;
		}
		return (
			(c.move = function (n, e) {
				n.tween
			...
			(c.extent = function (t) {
				return arguments.length
					? ((e = "function" == typeof t ? t : io(vo(t))), c)
					: e;
			}),
			(c.filter = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : io(!!t)), c)
					: r;
			}),
			(c.touchable = function (t) {
				return arguments.length
					? ((i = "function" == typeof t ? t : io(!!t)), c)
					: i;
			}),
	...
	function jo(t, n) {
			...
			u = (d = Io(0, Oo - e * c) / d) ? e : Oo / c;
			{
				...
				for (const e of s) {
					...
					if (t) {
						...
						const t = Yo(0, c).filter((t) => a[e * c + t] || a[t * c + e]);
		...
		return (
			(a.padAngle = function (t) {
				return arguments.length ? ((e = Io(0, t)), a) : e;
			}),
	...
	$o.prototype = Wo.prototype = {
			...
			if (null === this._x1)
				...
				if (Math.abs(s * u - c * f) > Go && i) {
					var h = e - o,
						...
						y = Math.sqrt(p),
						v = Math.sqrt(l),
						_ = i * Math.tan((Ho - Math.acos((p + l - g) / (2 * y * v))) / 2),
						b = _ / v,
						m = _ / y;
					Math.abs(b - 1) > Go &&
		...
		arc: function (t, n, e, r, i, o) {
			...
			null === this._x1
				? (this._ += "M" + c + "," + f)
				: (Math.abs(this._x1 - c) > Go || Math.abs(this._y1 - f) > Go) &&
				  (this._ += "L" + c + "," + f),
				e &&
					(l < 0 && (l = (l % Xo) + Xo),
					l > Vo
			...
			if (
				...
				if (t) {
					var m = +t.apply(this, arguments),
						x = v - m,
						w = (_ + b) / 2;
					c.quadraticCurveTo(0, 0, x * qo(_), x * Ro(_)),
						c.lineTo(v * qo(w), v * Ro(w)),
						c.lineTo(x * qo(b), x * Ro(b));
				} else
					c.quadraticCurveTo(0, 0, v * qo(_), v * Ro(_)), c.arc(0, 0, v, _, b);
			if ((c.quadraticCurveTo(0, 0, p * qo(g), p * Ro(g)), c.closePath(), f))
		...
		return (
			t &&
				(f.headRadius = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : Ko(+n)), f)
						: t;
				}),
			(f.radius = function (t) {
				return arguments.length
					? ((r = i = "function" == typeof t ? t : Ko(+t)), f)
					: r;
			}),
			(f.sourceRadius = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : Ko(+t)), f)
					: r;
			}),
			(f.targetRadius = function (t) {
				return arguments.length
					? ((i = "function" == typeof t ? t : Ko(+t)), f)
					: i;
			}),
			(f.startAngle = function (t) {
				return arguments.length
					? ((o = "function" == typeof t ? t : Ko(+t)), f)
					: o;
			}),
			(f.endAngle = function (t) {
				return arguments.length
					? ((a = "function" == typeof t ? t : Ko(+t)), f)
					: a;
			}),
			(f.padAngle = function (t) {
				return arguments.length
					? ((u = "function" == typeof t ? t : Ko(+t)), f)
					: u;
			}),
			(f.source = function (t) {
	...
	function pa() {
		...
		function i(t) {
			var n = e(t);
			if (Array.isArray(n)) n = n.slice().sort(ua);
			else {
				var r = p(t),
					i = r[0],
					a = r[1];
				(n = S(i, a, n)),
					(n = O(Math.floor(i / n) * n, Math.floor(a / n) * n, n));
			}
			...
			return (
				(function (e, r, i) {
					var o,
						...
						h = new Array(),
						d = new Array();
					(o = u = -1), (f = e[0] >= r), da[f << 1].forEach(p);
					for (; ++o < t - 1; )
						(c = f), (f = e[o + 1] >= r), da[c | (f << 1)].forEach(p);
					da[f << 0].forEach(p);
					for (; ++u < n - 1; ) {
						for (
							o = -1,
							...
							(c = f),
								...
								(l = s),
								(s = e[u * t + o + 1] >= r),
								da[c | (f << 1) | (s << 2) | (l << 3)].forEach(p);
						da[f | (s << 3)].forEach(p);
					}
					(o = -1), (s = e[u * t] >= r), da[s << 2].forEach(p);
					for (; ++o < t - 1; )
						(l = s),
							(s = e[u * t + o + 1] >= r),
							da[(s << 2) | (l << 3)].forEach(p);
					function p(t) {
						var n,
							e,
							r = [t[0][0] + o, t[0][1] + u],
				...
				u.forEach(function (t) {
					for (var n, e = 0, r = o.length; e < r; ++e)
						if (-1 !== fa((n = o[e])[0], t)) return void n.push(t);
				}),
		...
		return (
			...
			(i.smooth = function (t) {
				return arguments.length ? ((r = t ? u : ha), i) : r === u;
			}),
			i
		);
	}
	...
	const ma = Math.pow(2, -52),
		xa = new Uint32Array(512);
	class wa {
		static from(t, n = Ca, e = Pa) {
			const r = t.length,
		...
		update() {
			...
			for (let n = 0; n < o; n++) {
				if (n === h || n === d) continue;
				const e = Ea(y, v, _, b, t[2 * n], t[2 * n + 1]);
				e < m && ((p = n), (m = e));
			}
			let x = t[2 * p],
				w = t[2 * p + 1];
			if (m === 1 / 0) {
				...
				ka(this._ids, this._dists, 0, o - 1);
			...
			ka(this._ids, this._dists, 0, o - 1), (this._hullStart = h);
			let A = 3;
			(e[h] = n[p] = d),
				(e[d] = n[h] = p),
				(e[p] = n[d] = h),
			...
			for (let o, a, u = 0; u < this._ids.length; u++) {
				const c = this._ids[u],
					f = t[2 * c],
					s = t[2 * c + 1];
				if (u > 0 && Math.abs(f - o) <= ma && Math.abs(s - a) <= ma) continue;
				...
				for (
					;
					(g = e[y]), !Ta(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]);
				...
				for (
					;
					(g = e[_]), Ta(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]);
				...
				if (y === l)
					for (
						;
						(g = n[y]),
							Ta(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]);
	...
	function Ta(t, n, e, r, i, o) {
		return (
			(Aa(i, o, t, n, e, r) || Aa(t, n, e, r, i, o) || Aa(e, r, i, o, t, n)) < 0
		);
	}
	function Sa(t, n, e, r, i, o, a, u) {
		const c = t - a,
			f = n - u,
			s = e - a,
			l = r - u,
	...
	function ka(t, n, e, r) {
		if (r - e <= 20)
			...
			let i = e + 1,
				o = r;
			Na(t, (e + r) >> 1, i),
				n[t[e]] > n[t[r]] && Na(t, e, r),
				n[t[i]] > n[t[r]] && Na(t, i, r),
				n[t[e]] > n[t[i]] && Na(t, e, i);
			const a = t[i],
				u = n[a];
			for (;;) {
				do {
			...
			(t[e + 1] = t[o]),
				(t[o] = a),
				r - i + 1 >= o - e
					? (ka(t, n, i, r), ka(t, n, e, o - 1))
					: (ka(t, n, e, o - 1), ka(t, n, i, r));
		}
	}
	function Na(t, n, e) {
		const r = t[n];
	...
	class Da {
		...
		arc(t, n, e) {
			...
			null === this._x1
				? (this._ += `M${r},${i}`)
				: (Math.abs(this._x1 - r) > za || Math.abs(this._y1 - i) > za) &&
				  (this._ += "L" + r + "," + i),
				e &&
					(this._ += `A${e},${e},0,1,1,${
						t - e
	...
	class Ra {
		...
		render(t) {
			const n = null == t ? (t = new Da()) : void 0,
				{
		...
		renderCell(t, n) {
			const e = null == n ? (n = new Da()) : void 0,
				r = this._clip(t);
	...
	class Ya {
		...
		*neighbors(t) {
		...
		_step(t, n, e) {
			...
			let f = t,
				s = Ua(n - c[2 * t], 2) + Ua(e - c[2 * t + 1], 2);
			const l = r[t];
			let h = l;
			do {
				let r = u[h];
				const l = Ua(n - c[2 * r], 2) + Ua(e - c[2 * r + 1], 2);
				if (
					(l < s && ((s = l), (f = r)),
					(h = h % 3 == 2 ? h - 2 : h + 1),
					u[h] !== t)
				...
				if (((h = a[h]), -1 === h)) {
					if (
						((h = i[(o[t] + 1) % i.length]),
						h !== r && Ua(n - c[2 * h], 2) + Ua(e - c[2 * h + 1], 2) < s)
					)
						return h;
					break;
				}
		...
		renderPoints(t, n = 2) {
			const e = null == t ? (t = new Da()) : void 0,
				{ points: r } = this;
			for (let e = 0, i = r.length; e < i; e += 2) {
				const i = r[e],
					o = r[e + 1];
				t.moveTo(i + n, o), t.arc(i, o, n, 0, Fa);
			}
			return e && e.value();
		}
		renderHull(t) {
	...
	function Va(t) {
		...
		return isNaN(t)
			? "Invalid Date"
			: (function (t) {
					return t < 0 ? "-" + Ga(-t, 6) : t > 9999 ? "+" + Ga(t, 6) : Ga(t, 4);
			  })(t.getUTCFullYear()) +
					"-" +
					Ga(t.getUTCMonth() + 1, 2) +
					"-" +
					Ga(t.getUTCDate(), 2) +
					(i
						? "T" +
	...
	function $a(t) {
		...
		function r(t, n) {
			...
			for (
				...
				for (var l = []; r !== La && r !== ja; ) l.push(r), (r = s());
		...
		return {
			...
			formatBody: function (t, n) {
				return null == n && (n = Xa(t)), i(t, n).join("\n");
			},
	...
	function mu(t) {
		return (n, e) =>
			gu(n, e).then((n) => new DOMParser().parseFromString(n, t));
	}
	...
	function ku(t, n, e) {
		var r = new Nu(null == n ? Su : n, null == e ? Eu : e, NaN, NaN, NaN, NaN);
	...
	var Pu = (ku.prototype = Nu.prototype);
	function zu(t) {
		return function () {
			return t;
		};
	...
	(Pu.copy = function () {
		var t,
			n,
			e = new Nu(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
			r = this._root;
		if (!r) return e;
		if (!r.length) return (e._root = Cu(r)), e;
		...
		(Pu.add = function (t) {
			...
			return Au(this.cover(n, e), n, e, t);
		}),
		(Pu.addAll = function (t) {
			var n,
				e,
				r,
				i,
		...
		(Pu.visit = function (t) {
			var n,
				...
				c = this._root;
			for (
				c && u.push(new Tu(c, this._x0, this._y0, this._x1, this._y1));
				(n = u.pop());
				...
				if (
					...
					var f = (r + o) / 2,
						s = (i + a) / 2;
					(e = c[3]) && u.push(new Tu(e, f, s, o, a)),
						(e = c[2]) && u.push(new Tu(e, r, s, f, a)),
						(e = c[1]) && u.push(new Tu(e, f, i, o, s)),
						(e = c[0]) && u.push(new Tu(e, r, i, f, s));
				}
			return this;
		}),
		(Pu.visitAfter = function (t) {
			var n,
				e = [],
				r = [];
			for (
				this._root &&
				e.push(new Tu(this._root, this._x0, this._y0, this._x1, this._y1));
				(n = e.pop());
				...
				if (i.length) {
					var o,
						...
						s = (a + c) / 2,
						l = (u + f) / 2;
					(o = i[0]) && e.push(new Tu(o, a, u, s, l)),
						(o = i[1]) && e.push(new Tu(o, s, u, c, l)),
						(o = i[2]) && e.push(new Tu(o, a, l, s, f)),
						(o = i[3]) && e.push(new Tu(o, s, l, c, f));
				}
				r.push(n);
			}
	...
	function ju(t) {
		return (t = Lu(Math.abs(t))) ? t[1] : NaN;
	}
	var Hu,
		Xu = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
	function Gu(t) {
	...
	var Wu = {
		...
		s: function (t, n) {
			...
			var r = e[0],
				i = e[1],
				o = i - (Hu = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
				a = r.length;
			return o === a
				? r
				: o > a
				...
				: "0." + new Array(1 - o).join("0") + Lu(t, Math.max(0, n + o - 1))[0];
		},
	...
	function tc(t) {
		...
		return {
			...
			formatPrefix: function (t, n) {
				var e = l((((t = Gu(t)).type = "f"), t)),
					r = 3 * Math.max(-8, Math.min(8, Math.floor(ju(n) / 3))),
					i = Math.pow(10, -r),
					o = Ju[8 + r / 3];
				return function (t) {
					return e(i * t) + o;
	...
	function nc(n) {
		return (
			(Ku = tc(n)),
			(t.format = Ku.format),
			(t.formatPrefix = Ku.formatPrefix),
			Ku
		);
	}
	function ec(t) {
		return Math.max(0, -ju(Math.abs(t)));
	}
	function rc(t, n) {
		return Math.max(
			0,
			3 * Math.max(-8, Math.min(8, Math.floor(ju(n) / 3))) - ju(Math.abs(t))
		);
	}
	function ic(t, n) {
		return (
			(t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, ju(n) - ju(t)) + 1
		);
	}
	...
	var oc = 1e-6,
		...
		Tc = Math.tan;
	function Sc(t) {
		return t > 1 ? 0 : t < -1 ? uc : Math.acos(t);
	}
	function Ec(t) {
		return t > 1 ? cc : t < -1 ? -cc : Math.asin(t);
	}
	function kc(t) {
		return (t = wc(t / 2)) * t;
	}
	function Nc() {}
	function Cc(t, n) {
		t && zc.hasOwnProperty(t.type) && zc[t.type](t, n);
	}
	var Pc = {
		...
		zc = {
			...
			GeometryCollection: function (t, n) {
				for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) Cc(e[r], n);
			},
		};
	function Dc(t, n, e) {
		var r,
	...
	function qc(t, n) {
		var e = -1,
			r = t.length;
		for (n.polygonStart(); ++e < r; ) Dc(t[e], n, 1);
		n.polygonEnd();
	}
	function Rc(t, n) {
		t && Pc.hasOwnProperty(t.type) ? Pc[t.type](t, n) : Cc(t, n);
	}
	var Fc,
		Uc,
		Oc,
		...
		tf = {
			...
			polygonStart: function () {
				(Qc = new g()), (tf.lineStart = nf), (tf.lineEnd = ef);
			},
			polygonEnd: function () {
				var t = +Qc;
				Jc.add(t < 0 ? sc + t : t),
	...
	function of(t, n) {
		var e = (t *= hc) - Oc,
			...
			c = Ic * o + u * yc(i),
			f = u * r * wc(i);
		Qc.add(gc(f, c)), (Oc = t), (Ic = o), (Bc = a);
	}
	function af(t) {
		return [gc(t[1], t[0]), Ec(t[2])];
	}
	function uf(t) {
		var n = t[0],
			e = t[1],
			r = yc(e);
		return [r * yc(n), r * wc(n), wc(e)];
	}
	function cf(t, n) {
	...
	function hf(t) {
		var n = Ac(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
		(t[0] /= n), (t[1] /= n), (t[2] /= n);
	}
	var df,
		pf,
	...
	function Pf(t, n) {
		...
		if ($c) {
			...
			f ^ (u * Xc < c && c < u * t)
				? (o = i[1] * lc) > Hc && (Hc = o)
				: f ^ (u * Xc < (c = ((c + 360) % 360) - 180) && c < u * t)
				? (o = -i[1] * lc) < Lc && (Lc = o)
				: (n < Lc && (Lc = n), n > Hc && (Hc = n)),
				f
					? t < Xc
						? Uf(Yc, t) > Uf(Yc, jc) && (jc = t)
						: Uf(t, jc) > Uf(Yc, jc) && (Yc = t)
					: jc >= Yc
					? (t < Yc && (Yc = t), t > jc && (jc = t))
					: t > Xc
					? Uf(Yc, t) > Uf(Yc, jc) && (jc = t)
					: Uf(t, jc) > Uf(Yc, jc) && (Yc = t);
		} else Zc.push((Kc = [(Yc = t), (jc = t)]));
		n < Lc && (Lc = n), n > Hc && (Hc = n), ($c = e), (Xc = t);
	}
	function zf() {
		Nf.point = Pf;
	}
	function Df() {
		(Kc[0] = Yc), (Kc[1] = jc), (Nf.point = Cf), ($c = null);
	}
	function qf(t, n) {
		if ($c) {
			var e = t - Xc;
			Wc.add(dc(e) > 180 ? e + (e > 0 ? 360 : -360) : e);
		} else (Gc = t), (Vc = n);
		tf.point(t, n), Pf(t, n);
	}
	function Rf() {
	...
	var Bf = {
		...
		lineEnd: Gf,
		polygonStart: function () {
			(Bf.lineStart = Vf), (Bf.lineEnd = $f);
		},
		polygonEnd: function () {
			(Bf.lineStart = jf), (Bf.lineEnd = Gf);
		},
	};
	function Yf(t, n) {
		t *= hc;
		var e = yc((n *= hc));
		Lf(e * yc(t), e * wc(t), wc(n));
	}
	function Lf(t, n, e) {
		++df, (gf += (t - gf) / df), (yf += (n - yf) / df), (vf += (e - vf) / df);
	}
	function jf() {
		Bf.point = Hf;
	}
	...
	function $f() {
		Zf(Af, Tf), (Bf.point = Yf);
	}
	function Wf(t, n) {
		(Af = t), (Tf = n), (t *= hc), (n *= hc), (Bf.point = Zf);
		var e = yc(n);
		(Sf = e * yc(t)), (Ef = e * wc(t)), (kf = wc(n)), Lf(Sf, Ef, kf);
	}
	function Zf(t, n) {
		t *= hc;
		var e = yc((n *= hc)),
	...
	function Jf(t, n) {
		return [dc(t) > uc ? t + Math.round(-t / sc) * sc : t, n];
	}
	function ts(t, n, e) {
		return (t %= sc)
			? n || e
	...
	function ns(t) {
		return function (n, e) {
			return [(n += t) > uc ? n - sc : n < -uc ? n + sc : n, e];
		};
	}
	function es(t) {
		var n = ns(t);
	...
	function rs(t, n) {
		...
		function a(t, n) {
			var a = yc(n),
				...
				f = wc(n),
				s = f * e + u * r;
			return [gc(c * i - s * o, u * e - f * r), Ec(s * i + c * o)];
		}
		return (
			(a.invert = function (t, n) {
				var a = yc(n),
					...
					f = wc(n),
					s = f * i - c * o;
				return [gc(c * i + f * o, u * e + s * r), Ec(s * e - u * r)];
			}),
			a
		);
	}
	function is(t) {
		function n(n) {
			return ((n = t(n[0] * hc, n[1] * hc))[0] *= lc), (n[1] *= lc), n;
		}
		return (
			(t = ts(t[0] * hc, t[1] * hc, t.length > 2 ? t[2] * hc : 0)),
			(n.invert = function (n) {
				return ((n = t.invert(n[0] * hc, n[1] * hc))[0] *= lc), (n[1] *= lc), n;
			}),
			n
		);
	}
	function os(t, n, e, r, i, o) {
		if (e) {
			var a = yc(n),
				u = wc(n),
				c = r * e;
			...
			for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
				(f = af([a, -u * yc(s), -u * wc(s)])), t.point(f[0], f[1]);
		}
	}
	function as(t, n) {
		((n = uf(n))[0] -= t), hf(n);
		var e = Sc(-n[1]);
		return ((-n[2] < 0 ? -e : e) + sc - oc) % sc;
	}
	function us() {
		var t,
			n = [];
	...
	function cs(t, n) {
		return dc(t[0] - n[0]) < oc && dc(t[1] - n[1]) < oc;
	}
	function fs(t, n, e, r) {
		(this.x = t),
			(this.z = n),
		...
		if (
			(t.forEach(function (t) {
				if (!((n = t.length - 1) <= 0)) {
					...
					u.push((e = new fs(r, t, null, !0))),
						c.push((e.o = new fs(r, null, e, !1))),
						u.push((e = new fs(a, t, null, !1))),
						c.push((e.o = new fs(a, null, e, !0)));
				}
			}),
			u.length)
		) {
			for (c.sort(n), ls(u), ls(c), o = 0, a = c.length; o < a; ++o)
				c[o].e = e = !e;
			for (var f, s, l = u[0]; ; ) {
	...
	function hs(t) {
		return dc(t[0]) <= uc ? t[0] : Mc(t[0]) * (((dc(t[0]) + uc) % sc) - uc);
	}
	function ds(t, n) {
		var e = hs(n),
			r = n[1],
			...
			if ((h = (l = t[f]).length))
				for (
					...
					if (
						...
						var P = ff(o, C);
						hf(P);
						var z = (k ^ (T >= 0) ? -1 : 1) * Ec(P[2]);
						(r > z || (r === z && (C[0] || C[1]))) &&
							(u += k ^ (T >= 0) ? 1 : -1);
					}
				}
		return (a < -1e-6 || (a < oc && c < -1e-12)) ^ (1 & u);
	}
	function ps(t, n, e, r) {
		return function (i) {
			var o,
				...
				h = {
					...
					polygonEnd: function () {
						...
						var t = ds(o, r);
						a.length
							? (l || (i.polygonStart(), (l = !0)), ss(a, ys, t, e, i))
							: t &&
	...
	function ys(t, n) {
		return (
			((t = t.x)[0] < 0 ? t[1] - cc - oc : cc - t[1]) -
			((n = n.x)[0] < 0 ? n[1] - cc - oc : cc - n[1])
		);
	}
	Jf.invert = Jf;
	var vs = ps(
		...
		function a(t, e, r) {
			...
			if (!(y < 0)) {
				...
				if (
					...
					T || A < oc
						? T
							? (w + M > 0) ^ (_[1] < (dc(_[0] - m) < oc ? w : M))
							: w <= _[1] && _[1] <= M
						: (A > uc) ^ (m <= _[0] && _[0] <= x))
				) {
					var S = lf(d, (-p + v) / g);
					return sf(S, h), [_, af(S)];
				}
			}
		}
		function u(n, e) {
				...
				return {
					...
					point: function (l, h) {
						var d,
							p = [l, h],
							g = o(l, h),
							y = r ? (g ? 0 : u(l, h)) : g ? u(l + (l < 0 ? uc : -uc), h) : 0;
						if (
							(!n && (f = c = g) && t.lineStart(),
							g !== c && (!(d = a(n, p)) || cs(n, d) || cs(p, d)) && (p[2] = 1),
							g !== c)
						)
							(s = 0),
								g
		...
		return function (a) {
			...
			function M(o, a) {
				...
				if ((f && s.push([o, a]), v))
					...
					var c = [
							(p = Math.max(As, Math.min(Ms, p))),
							(g = Math.max(As, Math.min(Ms, g))),
						],
						m = [
							(o = Math.max(As, Math.min(Ms, o))),
							(a = Math.max(As, Math.min(Ms, a))),
						];
	...
	function Es() {
		Ss.point = Ss.lineEnd = Nc;
	}
	function ks(t, n) {
		(ms = t *= hc), (xs = wc((n *= hc))), (ws = yc(n)), (Ss.point = Ns);
	}
	function Ns(t, n) {
		t *= hc;
		var e = wc((n *= hc)),
			...
			u = ws * e - xs * r * o,
			c = xs * e + ws * r * o;
		bs.add(gc(Ac(a * a + u * u), c)), (ms = t), (xs = e), (ws = r);
	}
	function Cs(t) {
		return (bs = new g()), Rc(t, Ss), +bs;
	}
	var Ps = [null, null],
		zs = { type: "LineString", coordinates: Ps };
	function Ds(t, n) {
		return (Ps[0] = t), (Ps[1] = n), Cs(zs);
	}
	var qs = {
			Feature: function (t, n) {
				return Fs(t.geometry, n);
			},
			FeatureCollection: function (t, n) {
				for (var e = t.features, r = -1, i = e.length; ++r < i; )
					if (Fs(e[r].geometry, n)) return !0;
				return !1;
			},
		},
		Rs = {
			...
			MultiLineString: function (t, n) {
				for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
					if (Os(e[r], n)) return !0;
				return !1;
			},
			Polygon: function (t, n) {
				return Is(t.coordinates, n);
			},
			MultiPolygon: function (t, n) {
				for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
					if (Is(e[r], n)) return !0;
				return !1;
			},
			GeometryCollection: function (t, n) {
	...
	function Fs(t, n) {
		return !(!t || !Rs.hasOwnProperty(t.type)) && Rs[t.type](t, n);
	}
	function Us(t, n) {
		return 0 === Ds(t, n);
	}
	function Os(t, n) {
		for (var e, r, i, o = 0, a = t.length; o < a; o++) {
			if (0 === (r = Ds(t[o], n))) return !0;
			if (
				o > 0 &&
				(i = Ds(t[o], t[o - 1])) > 0 &&
				e <= i &&
				r <= i &&
				(e + r - i) * (1 - Math.pow((e - r) / i, 2)) < ac * i
			)
				return !0;
			e = r;
		}
	...
	function Is(t, n) {
		return !!ds(t.map(Bs), Ys(n));
	}
	function Bs(t) {
		return (t = t.map(Ys)).pop(), t;
	}
	function Ys(t) {
		return [t[0] * hc, t[1] * hc];
	}
	function Ls(t, n, e) {
		var r = O(t, n - oc, e).concat(n);
		return function (t) {
	...
	function Hs() {
		...
		function _() {
			return O(vc(r / p) * p, e, p)
				.map(s)
				.concat(O(vc(u / g) * g, a, g).map(l))
				.concat(
					O(vc(n / h) * h, t, h)
						.filter(function (t) {
							return dc(t % p) > oc;
	...
	var Xs,
		...
		Qs = {
			...
			lineEnd: Nc,
			polygonStart: function () {
				(Qs.lineStart = Js), (Qs.lineEnd = el);
			},
			polygonEnd: function () {
				(Qs.lineStart = Qs.lineEnd = Qs.point = Nc),
					Zs.add(dc(Ks)),
					(Ks = new g());
			},
			result: function () {
	...
	function tl(t, n) {
		(Qs.point = nl), (Xs = Vs = t), (Gs = $s = n);
	}
	function nl(t, n) {
		Ks.add($s * t - Vs * n), (Vs = t), ($s = n);
	}
	function el() {
		nl(Xs, Gs);
	}
	...
	var cl,
		...
		xl = {
			...
			lineEnd: Sl,
			polygonStart: function () {
				(xl.lineStart = El), (xl.lineEnd = kl);
			},
			polygonEnd: function () {
				(xl.point = wl), (xl.lineStart = Ml), (xl.lineEnd = Sl);
			},
			result: function () {
				var t = ml
					? [_l / ml, bl / ml]
					...
					? [hl / pl, dl / pl]
					: [NaN, NaN];
				return (hl = dl = pl = gl = yl = vl = _l = bl = ml = 0), t;
			},
		};
	function wl(t, n) {
		(hl += t), (dl += n), ++pl;
	...
	function Nl(t, n) {
		(xl.point = Cl), wl((cl = sl = t), (fl = ll = n));
	}
	function Cl(t, n) {
		var e = t - sl,
			r = n - ll,
			...
			switch (this._point) {
				...
				default:
					this._context.moveTo(t + this._radius, n),
						this._context.arc(t, n, this._radius, 0, sc);
			}
		},
		result: Nc,
	};
	...
	function Il(t, n) {
		(Ol.point = Bl), (Dl = Rl = t), (ql = Fl = n);
	}
	function Bl(t, n) {
		(Rl -= t), (Fl -= n), Ul.add(Ac(Rl * Rl + Fl * Fl)), (Rl = t), (Fl = n);
	}
	function Yl() {
		this._string = [];
	}
		...
		point: function (t, n) {
			switch (this._point) {
				...
				case 1:
					...
					break;
				default:
					null == this._circle && (this._circle = Ll(this._radius)),
					...
					function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
						...
						if (b > 4 * n && g--) {
							var m = a + h,
								...
								A = Ec((w /= M)),
								T =
									dc(dc(w) - 1) < oc || dc(o - l) < oc ? (o + l) / 2 : gc(x, m),
								S = t(T, A),
								E = S[0],
								k = S[1],
								N = E - r,
	...
	function nh(t) {
		var n,
			...
			S = 0.5;
		function E(t) {
			return c(t[0] * hc, t[1] * hc);
		}
		function k(t) {
			return (t = c.invert(t[0], t[1])) && [t[0] * lc, t[1] * lc];
		}
		function N() {
			var t = Jl(l, 0, 0, m, x, b).apply(null, n(p, g)),
				r = Jl(l, h - t[0], d - t[1], m, x, b);
			return (
				(e = ts(y, v, _)), (u = Qf(n, r)), (c = Qf(e, u)), (a = Kl(u, S)), C()
			);
		}
		function C() {
			return (f = s = null), E;
		...
		return (
			...
			(E.rotate = function (t) {
				return arguments.length
					? ((y = (t[0] % 360) * hc),
					  (v = (t[1] % 360) * hc),
					  (_ = t.length > 2 ? (t[2] % 360) * hc : 0),
					  N())
					: [y * lc, v * lc, _ * lc];
			}),
			(E.angle = function (t) {
				return arguments.length ? ((b = (t % 360) * hc), N()) : b * lc;
			}),
			...
			(E.precision = function (t) {
				return arguments.length ? ((a = Kl(u, (S = t * t))), C()) : Ac(S);
			}),
	...
	function rh(t, n) {
		...
		var i = 1 + e * (2 * r - e),
			o = Ac(i) / r;
		function a(t, n) {
			var e = Ac(i - 2 * r * wc(n)) / r;
			return [e * wc((t *= r)), o - e * yc(t)];
		}
		return (
			(a.invert = function (t, n) {
				var e = o - n,
					a = gc(t, dc(e)) * Mc(e);
				return (
					e * r < 0 && (a -= uc * Mc(t) * Mc(e)),
					[a / r, Ec((i - (t * t + e * e) * r * r) / (2 * r))]
				);
			}),
			a
		);
	...
	function ih() {
		return eh(rh).scale(155.424).center([0, 33.6442]);
	}
	function oh() {
		return ih()
			.parallels([29.5, 45.5])
	...
	function ah(t) {
		return function (n, e) {
			var r = yc(n),
				i = yc(e),
				o = t(r * i);
			return o === 1 / 0 ? [2, 0] : [o * i * wc(n), o * wc(e)];
		};
	}
	function uh(t) {
		return function (n, e) {
			var r = Ac(n * n + e * e),
				...
				o = wc(i),
				a = yc(i);
			return [gc(n * o, r * a), Ec(r && (e * o) / r)];
		};
	}
	var ch = ah(function (t) {
		return Ac(2 / (1 + t));
	});
	ch.invert = uh(function (t) {
		return 2 * Ec(t / 2);
	});
	var fh = ah(function (t) {
		return (t = Sc(t)) && t / wc(t);
	});
	function sh(t, n) {
		return [t, mc(Tc((cc + n) / 2))];
	}
	function lh(t) {
		var n,
			e,
	...
	function dh(t, n) {
		var e = yc(t),
			r = t === n ? wc(t) : mc(e / yc(n)) / mc(hh(n) / hh(t)),
			i = (e * xc(hh(t), r)) / r;
		if (!r) return sh;
		function o(t, n) {
			i > 0 ? n < -cc + oc && (n = -cc + oc) : n > cc - oc && (n = cc - oc);
			var e = i / xc(hh(n), r);
			return [e * wc(r * t), i - e * yc(r * t)];
		}
		return (
	...
	function gh(t, n) {
		var e = yc(t),
			r = t === n ? wc(t) : (e - yc(n)) / (n - t),
			i = e / r + t;
		if (dc(r) < oc) return ph;
		function o(t, n) {
			var e = i - n,
				o = r * t;
			return [e * wc(o), i - e * yc(o)];
		}
		return (
			(o.invert = function (t, n) {
				var e = i - n,
					o = gc(t, dc(e)) * Mc(e);
				return (
					e * r < 0 && (o -= uc * Mc(t) * Mc(e)),
					[o / r, i - Mc(r) * Ac(t * t + e * e)]
				);
			}),
			o
		);
	}
	(fh.invert = uh(function (t) {
		return t;
	})),
		(sh.invert = function (t, n) {
			return [t, 2 * pc(_c(n)) - cc];
		}),
		(ph.invert = ph);
	var yh = 1.340264,
		vh = -0.081106,
	...
	function xh(t, n) {
		var e = Ec(mh * wc(n)),
			...
			i = r * r * r;
		return [
			(t * yc(e)) / (mh * (yh + 3 * vh * r + i * (7 * _h + 9 * bh * r))),
			e * (yh + vh * r + i * (_h + bh * r)),
		];
	}
	function wh(t, n) {
	...
	function Ph(t, n) {
		t instanceof Map
			? ((t = [void 0, t]), void 0 === n && (n = Dh))
			: void 0 === n && (n = zh);
		for (var e, r, i, o, a, u = new Fh(t), c = [u]; (e = c.pop()); )
			if ((i = n(e.data)) && (a = (i = Array.from(i)).length))
				for (e.children = i, o = a - 1; o >= 0; --o)
					c.push((r = i[o] = new Fh(i[o]))),
						(r.parent = e),
						(r.depth = e.depth + 1);
		return u.eachBefore(Rh);
	}
	function zh(t) {
		return t.children;
	}
	...
	function Uh(t) {
		for (
			...
			(n = t[r]), e && Bh(e, n) ? ++r : ((e = Lh((o = Oh(o, n)))), (r = 0));
		return e;
	}
	function Oh(t, n) {
		var e, r;
		...
		for (e = 0; e < t.length; ++e)
			if (Ih(n, t[e]) && Yh(jh(t[e], n), t)) return [t[e], n];
	...
	function Yh(t, n) {
		for (var e = 0; e < n.length; ++e) if (!Bh(t, n[e])) return !1;
		return !0;
	}
	function Lh(t) {
		switch (t.length) {
	...
	function Wh(t) {
		...
		t: for (u = 3; u < i; ++u) {
			...
			for (
				r.previous = n, r.next = e, n.next = e.previous = e = r, o = Vh(n);
				(r = r.next) !== e;
		...
		for (r = Uh(n), u = 0; u < i; ++u) ((n = t[u]).x -= r.x), (n.y -= r.y);
		return r.r;
	}
	function Zh(t) {
		return null == t ? null : Kh(t);
	}
	function Kh(t) {
		if ("function" != typeof t) throw new Error();
		return t;
	...
	function ed(t, n) {
		return function (e) {
			if ((r = e.children)) {
				...
				if (((o = Wh(r)), u)) for (i = 0; i < a; ++i) r[i].r -= u;
				e.r = o + u;
			}
		};
	}
	...
	(xh.invert = function (t, n) {
		for (
			...
			((o =
				(i =
					(r -= e =
						(r * (yh + vh * i + o * (_h + bh * i)) - n) /
						(yh + 3 * vh * i + o * (7 * _h + 9 * bh * i))) * r) *
				i *
				i),
			!(dc(e) < ac));
			++a
		...
		return [
			(mh * t * (yh + 3 * vh * i + o * (7 * _h + 9 * bh * i))) / yc(r),
			Ec(wc(r) / mh),
		];
	}),
		(wh.invert = uh(pc)),
		...
		(Ah.invert = uh(Ec)),
		(Th.invert = uh(function (t) {
			return 2 * pc(t);
		})),
		(Sh.invert = function (t, n) {
			return [-n, 2 * pc(_c(t)) - cc];
		}),
		(Fh.prototype = Ph.prototype = {
			constructor: Fh,
			count: function () {
	...
	gd.prototype = Object.create(Fh.prototype);
	var vd = (1 + Math.sqrt(5)) / 2;
	function _d(t, n, e, r, i, o) {
		for (
			var a,
				u,
				c,
			...
			if ((a = t._squarify) && a.ratio === n)
				for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
					...
					u.dice
						...
						: yd(u, e, r, d ? (e += ((i - e) * u.value) / d) : i, o),
						(d -= u.value);
				}
			else (t._squarify = a = _d(n, t, e, r, i, o)), (a.ratio = n);
		}
		return (
			(e.ratio = function (n) {
				return t((n = +n) > 1 ? n : 1);
	...
	function Md(t) {
		...
		let r,
			i = 2;
		for (r = 2; r < n; ++r) {
			for (; i > 1 && xd(t[e[i - 2]], t[e[i - 1]], t[r]) <= 0; ) --i;
			e[i++] = r;
		}
		return e.slice(0, i);
	}
	...
	function Gd() {
		...
		return (
			...
			(i.copy = function () {
				return Gd(n, e).unknown(r);
			}),
			jd.apply(i, arguments),
			i
		);
	}
	function Vd() {
	...
	function Jd(t, n, e) {
		var r = t[0],
			...
			a = n[1];
		return (
			i < r ? ((r = Qd(i, r)), (o = e(a, o))) : ((r = Qd(r, i)), (o = e(o, a))),
			function (t) {
				return o(r(t));
			}
		);
	...
	function tp(t, n, e) {
		...
		for (
			...
			(i[u] = Qd(t[u], t[u + 1])), (a[u] = e(n[u], n[u + 1]));
		return function (n) {
			var e = o(t, n, 1, r) - 1;
			return a[e](i[e](n));
		};
	...
	function ep() {
		...
		return (
			(l.invert = function (e) {
				return f(n((o || (o = r(u, a.map(t), ir)))(e)));
			}),
			(l.domain = function (t) {
				return arguments.length ? ((a = Array.from(t, Wd)), s()) : a.slice();
			}),
			(l.range = function (t) {
				return arguments.length ? ((u = Array.from(t)), s()) : u.slice();
			}),
			(l.rangeRound = function (t) {
				return (u = Array.from(t)), (c = sr), s();
			}),
			(l.clamp = function (t) {
				return arguments.length ? ((f = !!t || Kd), s()) : f !== Kd;
			}),
	...
	function ip(n, e, r, i) {
		var o,
			a = S(n, e, r);
		switch ((i = Gu(null == i ? ",f" : i)).type) {
			case "s":
				var u = Math.max(Math.abs(n), Math.abs(e));
				return (
					null != i.precision || isNaN((o = rc(a, u))) || (i.precision = o),
					t.formatPrefix(i, u)
				);
			case "":
			case "e":
			...
			case "r":
				null != i.precision ||
					isNaN((o = ic(a, Math.max(Math.abs(n), Math.abs(e))))) ||
	...
	function dp(n) {
		...
		function u() {
			return (
				...
				o()[0] < 0 ? ((e = hp(e)), (r = hp(r)), n(fp, sp)) : n(up, cp),
				i
			);
		}
		return (
	...
	function yp(t) {
		...
		return (
			(e.constant = function (e) {
				return arguments.length ? t(pp((n = +e)), gp(n)) : n;
			}),
			op(e)
		);
	}
	...
	function mp(t) {
		var n = t(Kd, Kd),
			e = 1;
		function r() {
			return 1 === e ? t(Kd, Kd) : 0.5 === e ? t(_p, bp) : t(vp(e), vp(1 / e));
		}
		return (
		...
		return (
			...
			e &&
				((i.count = function (n, r) {
					return (
						Ap.setTime(+n), Tp.setTime(+r), t(Ap), t(Tp), Math.floor(e(Ap, Tp))
					);
				}),
				(i.every = function (t) {
					return (
	...
	var kp = Ep.range,
		...
		Fp = Sp(
			function (t) {
				t.setTime(t - t.getMilliseconds() - t.getSeconds() * Np);
			},
			function (t, n) {
				t.setTime(+t + n * Cp);
			},
		...
		Op = Sp(
			function (t) {
				t.setTime(
					t - t.getMilliseconds() - t.getSeconds() * Np - t.getMinutes() * Cp
				);
			},
			function (t, n) {
				t.setTime(+t + n * Pp);
		...
		Bp = Sp(
			...
			(t, n) =>
				(n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Cp) / zp,
			(t) => t.getDate() - 1
		),
		Yp = Bp.range;
	function Lp(t) {
		return Sp(
			...
			function (t, n) {
				return (
					(n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Cp) / Dp
				);
			}
		);
	}
		...
		function M(t, n) {
			return function (e) {
				...
				if (
					...
					"w" in o || (o.w = 1),
						"Z" in o
							? ((i = (r = Dg(qg(o.y, 0, 1))).getUTCDay()),
							  (r = i > 4 || 0 === i ? gg.ceil(r) : gg(r)),
							  (r = lg.offset(r, 7 * (o.V - 1))),
							  (o.y = r.getUTCFullYear()),
							  (o.m = r.getUTCMonth()),
							  (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
							: ((i = (r = zg(qg(o.y, 0, 1))).getDay()),
							  (r = i > 4 || 0 === i ? Hp.ceil(r) : Hp(r)),
							  (r = Bp.offset(r, 7 * (o.V - 1))),
							  (o.y = r.getFullYear()),
							  (o.m = r.getMonth()),
							  (o.d = r.getDate() + ((o.w + 6) % 7)));
				} else ("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), (i = "Z" in o ? Dg(qg(o.y, 0, 1)).getUTCDay() : zg(qg(o.y, 0, 1)).getDay()), (o.m = 0), (o.d = "W" in o ? ((o.w + 6) % 7) + 7 * o.W - ((i + 5) % 7) : o.w + 7 * o.U - ((i + 6) % 7)));
				return "Z" in o
					? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Dg(o))
					: zg(o);
			};
		}
		function A(t, n, e, r) {
			for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
				...
				if (37 === (i = n.charCodeAt(a++))) {
					if (
						((i = n.charAt(a++)),
						!(o = x[i in Ug ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
					)
						return -1;
	...
	function jg(t) {
		return new RegExp("^(?:" + t.map(Lg).join("|") + ")", "i");
	}
	function Hg(t) {
	...
	function ly(t, n) {
		return Yg(t.getDate(), n, 2);
	}
	function hy(t, n) {
		return Yg(t.getHours(), n, 2);
	}
	function dy(t, n) {
		return Yg(t.getHours() % 12 || 12, n, 2);
	}
	function py(t, n) {
		return Yg(1 + Bp.count(og(t), t), n, 3);
	}
	function gy(t, n) {
		return Yg(t.getMilliseconds(), n, 3);
	}
	function yy(t, n) {
		return gy(t, n) + "000";
	}
	function vy(t, n) {
		return Yg(t.getMonth() + 1, n, 2);
	}
	function _y(t, n) {
		return Yg(t.getMinutes(), n, 2);
	}
	function by(t, n) {
		return Yg(t.getSeconds(), n, 2);
	}
	function my(t) {
		var n = t.getDay();
		return 0 === n ? 7 : n;
	...
	function xy(t, n) {
		return Yg(jp.count(og(t) - 1, t), n, 2);
	}
	function wy(t) {
		var n = t.getDay();
		return n >= 4 || 0 === n ? Vp(t) : Vp.ceil(t);
	}
	function My(t, n) {
		return (t = wy(t)), Yg(Vp.count(og(t), t) + (4 === og(t).getDay()), n, 2);
	}
	function Ay(t) {
		return t.getDay();
	}
	function Ty(t, n) {
		return Yg(Hp.count(og(t) - 1, t), n, 2);
	}
	function Sy(t, n) {
		return Yg(t.getFullYear() % 100, n, 2);
	}
	function Ey(t, n) {
		return Yg((t = wy(t)).getFullYear() % 100, n, 2);
	}
	function ky(t, n) {
		return Yg(t.getFullYear() % 1e4, n, 4);
	}
	function Ny(t, n) {
		var e = t.getDay();
		return Yg(
			(t = e >= 4 || 0 === e ? Vp(t) : Vp.ceil(t)).getFullYear() % 1e4,
			n,
			4
		);
	}
	...
	function Py(t, n) {
		return Yg(t.getUTCDate(), n, 2);
	}
	function zy(t, n) {
		return Yg(t.getUTCHours(), n, 2);
	}
	function Dy(t, n) {
		return Yg(t.getUTCHours() % 12 || 12, n, 2);
	}
	function qy(t, n) {
		return Yg(1 + lg.count(Cg(t), t), n, 3);
	}
	function Ry(t, n) {
		return Yg(t.getUTCMilliseconds(), n, 3);
	}
	function Fy(t, n) {
		return Ry(t, n) + "000";
	}
	function Uy(t, n) {
		return Yg(t.getUTCMonth() + 1, n, 2);
	}
	function Oy(t, n) {
		return Yg(t.getUTCMinutes(), n, 2);
	}
	function Iy(t, n) {
		return Yg(t.getUTCSeconds(), n, 2);
	}
	function By(t) {
		var n = t.getUTCDay();
		return 0 === n ? 7 : n;
	...
	function Yy(t, n) {
		return Yg(pg.count(Cg(t) - 1, t), n, 2);
	}
	function Ly(t) {
		var n = t.getUTCDay();
		return n >= 4 || 0 === n ? _g(t) : _g.ceil(t);
	}
	function jy(t, n) {
		return (
			(t = Ly(t)), Yg(_g.count(Cg(t), t) + (4 === Cg(t).getUTCDay()), n, 2)
		);
	}
	function Hy(t) {
		return t.getUTCDay();
	...
	function Xy(t, n) {
		return Yg(gg.count(Cg(t) - 1, t), n, 2);
	}
	function Gy(t, n) {
		return Yg(t.getUTCFullYear() % 100, n, 2);
	}
	function Vy(t, n) {
		return Yg((t = Ly(t)).getUTCFullYear() % 100, n, 2);
	}
	function $y(t, n) {
		return Yg(t.getUTCFullYear() % 1e4, n, 4);
	}
	function Wy(t, n) {
		var e = t.getUTCDay();
		return Yg(
			(t = e >= 4 || 0 === e ? _g(t) : _g.ceil(t)).getUTCFullYear() % 1e4,
			n,
			4
		);
	}
	...
	function tv(n) {
		return (
			(Fg = Rg(n)),
			(t.timeFormat = Fg.format),
			(t.timeParse = Fg.parse),
			(t.utcFormat = Fg.utcFormat),
			(t.utcParse = Fg.utcParse),
			Fg
		);
	}
	tv({
	...
	var nv = "%Y-%m-%dT%H:%M:%S.%LZ";
	var ev = Date.prototype.toISOString
		? function (t) {
				return t.toISOString();
		  }
		: t.utcFormat(nv);
	var rv = +new Date("2000-01-01T00:00:00.000Z")
			? function (t) {
					var n = new Date(t);
	...
	function hv(t, n, r, i, o, a, u, c, f) {
		...
		return (
			...
			(s.domain = function (t) {
				return arguments.length ? h(Array.from(t, lv)) : h().map(sv);
			}),
			(s.ticks = function (t) {
				var n,
					e = h(),
			...
			(s.nice = function (t) {
				var n = h();
				return (t = M(t, n[0], n[n.length - 1])) ? h(ap(n, t)) : s;
			}),
			(s.copy = function () {
				return np(s, hv(t, n, r, i, o, a, u, c, f));
			}),
			s
		);
	}
	...
	var bv = _v("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
		mv = _v("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666"),
		xv = _v("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666"),
		wv = _v(
			"a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928"
		),
		Mv = _v("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2"),
		Av = _v("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc"),
		Tv = _v("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999"),
		Sv = _v("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3"),
		Ev = _v(
			"8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f"
		),
		kv = _v("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"),
		Nv = (t) => Qe(t[t.length - 1]),
		Cv = new Array(3)
			.concat(
				"d8b365f5f5f55ab4ac",
		...
		k_ = new Array(3)
			...
			.map(_v),
		N_ = Nv(k_);
	var C_ = kr(Be(300, 0.5, 0), Be(-240, 0.5, 1)),
		P_ = kr(Be(-100, 0.75, 0.35), Be(80, 1.5, 0.8)),
		z_ = kr(Be(260, 0.75, 0.35), Be(80, 1.5, 0.8)),
		D_ = Be();
	var q_ = re(),
		R_ = Math.PI / 3,
		F_ = (2 * Math.PI) / 3;
	...
	function nb(t) {
		return t >= 1 ? Q_ : t <= -1 ? -Q_ : Math.asin(t);
	}
	function eb(t) {
	...
	function gb(t, n) {
		...
		return (
			(t = "function" == typeof t ? t : void 0 === t ? db : L_(t)),
			(n = "function" == typeof n ? n : void 0 === n ? pb : L_(n)),
			(a.x = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : L_(+n)), a)
					: t;
			}),
			(a.y = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : L_(+t)), a)
					: n;
			}),
			(a.defined = function (t) {
				return arguments.length
					? ((e = "function" == typeof t ? t : L_(!!t)), a)
					: e;
			}),
			(a.curve = function (t) {
	...
	function yb(t, n, e) {
		...
		function f() {
			return gb().defined(i).curve(a).context(o);
		}
		return (
			(t = "function" == typeof t ? t : void 0 === t ? db : L_(+t)),
			(n = "function" == typeof n ? n : L_(void 0 === n ? 0 : +n)),
			(e = "function" == typeof e ? e : void 0 === e ? pb : L_(+e)),
			(c.x = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : L_(+n)), (r = null), c)
					: t;
			}),
			(c.x0 = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : L_(+n)), c)
					: t;
			}),
			(c.x1 = function (t) {
				return arguments.length
					? ((r = null == t ? null : "function" == typeof t ? t : L_(+t)), c)
					: r;
			}),
			(c.y = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : L_(+t)), (e = null), c)
					: n;
			}),
			(c.y0 = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : L_(+t)), c)
					: n;
			}),
			(c.y1 = function (t) {
				return arguments.length
					? ((e = null == t ? null : "function" == typeof t ? t : L_(+t)), c)
					: e;
			}),
	...
	function wb(t) {
		...
		return (
			...
			delete t.y,
			(t.curve = function (t) {
				return arguments.length ? n(xb(t)) : n()._curve;
			}),
			t
		);
	}
	function Mb() {
		return wb(gb().curve(bb));
	}
	function Ab() {
		var t = yb().curve(bb),
			n = t.curve,
	...
	function kb(t) {
		...
		return (
			...
			(a.x = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : L_(+t)), a)
					: r;
			}),
			(a.y = function (t) {
				return arguments.length
					? ((i = "function" == typeof t ? t : L_(+t)), a)
					: i;
			}),
			(a.context = function (t) {
	...
	var zb = {
			draw: function (t, n) {
				var e = Math.sqrt(n / K_);
				t.moveTo(e, 0), t.arc(0, 0, e, 0, J_);
			},
		},
		Db = {
			draw: function (t, n) {
		...
		Ub = Math.sin(K_ / 10) / Math.sin((7 * K_) / 10),
		Ob = Math.sin(J_ / 10) * Ub,
		Ib = -Math.cos(J_ / 10) * Ub,
		Bb = {
			draw: function (t, n) {
		...
		$b = {
			draw: function (t, n) {
				...
				t.moveTo(r, i),
					...
					t.lineTo(Hb * o - Xb * a, Xb * o + Hb * a),
					t.lineTo(Hb * u - Xb * c, Xb * u + Hb * c),
					t.lineTo(Hb * r + Xb * i, Hb * i - Xb * r),
					t.lineTo(Hb * o + Xb * a, Hb * a - Xb * o),
					t.lineTo(Hb * u + Xb * c, Hb * c - Xb * u),
					t.closePath();
			},
		},
		Wb = [zb, Db, Fb, Yb, Bb, jb, $b];
	function Zb() {}
	function Kb(t, n, e) {
	...
	function nm(t, n) {
		(this._basis = new Qb(t)), (this._beta = n);
	}
	(Qb.prototype = {
		areaStart: function () {
			this._line = 0;
	...
	var em = (function t(n) {
		function e(t) {
			return 1 === n ? new Qb(t) : new nm(t, n);
		}
		return (
			(e.beta = function (n) {
				return t(+n);
	...
	var hm = (function t(n) {
		function e(t) {
			return n ? new lm(t, n) : new im(t, 0);
		}
		return (
			(e.alpha = function (n) {
				return t(+n);
	...
	var pm = (function t(n) {
		function e(t) {
			return n ? new dm(t, n) : new am(t, 0);
		}
		return (
			(e.alpha = function (n) {
				return t(+n);
	...
	function bm(t, n, e) {
		var r = t._x1 - t._x0,
			...
			u = (o * i + a * r) / (r + i);
		return (
			(_m(o) + _m(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
			0
		);
	}
	function mm(t, n) {
	...
	(vm.prototype = {
			...
			lineEnd: function () {
				switch (this._point) {
					case 2:
						...
						break;
					case 3:
						xm(this, this._t0, mm(this, this._t0));
				}
				(this._line || (0 !== this._line && 1 === this._point)) &&
					this._context.closePath(),
					(this._line = 1 - this._line);
				...
				if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
					switch (this._point) {
						...
						case 1:
							...
							break;
						case 2:
							(this._point = 3), xm(this, mm(this, (e = bm(this, t, n))), e);
							break;
						default:
							xm(this, this._t0, (e = bm(this, t, n)));
					}
					(this._x0 = this._x1),
						(this._x1 = t),
						(this._y0 = this._y1),
		...
		((Mm.prototype = Object.create(wm.prototype)).point = function (t, n) {
			wm.prototype.point.call(this, n, t);
		}),
		(Am.prototype = {
			moveTo: function (t, n) {
			...
			lineEnd: function () {
				...
				if (e)
					if (
						...
						for (var r = Sm(t), i = Sm(n), o = 0, a = 1; a < e; ++o, ++a)
	...
	var Fm = (t) => () => t;
	function Um(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
		Object.defineProperties(this, {
			type: { value: t, enumerable: !0, configurable: !0 },
			sourceEvent: { value: n, enumerable: !0, configurable: !0 },
			target: { value: e, enumerable: !0, configurable: !0 },
	...
	Om.prototype = {
		constructor: Om,
		scale: function (t) {
			return 1 === t ? this : new Om(this.k * t, this.x, this.y);
		},
		translate: function (t, n) {
			return (0 === t) & (0 === n)
				? this
				: new Om(this.k, this.x + this.k * t, this.y + this.k * n);
		},
		apply: function (t) {
	...
	var Im = new Om(1, 0, 0);
	function Bm(t) {
		for (; !t.__zoom; ) if (!(t = t.parentNode)) return Im;
		return t.__zoom;
	}
	function Ym(t) {
		t.stopImmediatePropagation();
	...
	(Bm.prototype = Om.prototype),
		(t.Adder = g),
		(t.Delaunay = Ya),
		(t.FormatSpecifier = Vu),
		(t.Voronoi = Ra),
		...
		(t.arc = function () {
			...
			function c() {
				var c,
					...
					h = i.apply(this, arguments) - Q_,
					d = o.apply(this, arguments) - Q_,
					p = j_(d - h),
					g = d > h;
				if ((u || (u = c = Wo()), l < s && ((f = l), (l = s), (s = f)), l > Z_))
					if (p > J_ - Z_)
						u.moveTo(l * X_(h), l * $_(h)),
							u.arc(0, 0, l, h, d, !g),
							s > Z_ &&
								(u.moveTo(s * X_(d), s * $_(d)), u.arc(0, 0, s, d, h, g));
					else {
						var y,
							v,
							_ = h,
							...
							T = A > Z_ && (r ? +r.apply(this, arguments) : W_(s * s + l * l)),
							S = V_(j_(l - s) / 2, +e.apply(this, arguments)),
							E = S,
							k = S;
						if (T > Z_) {
							var N = nb((T / s) * $_(A)),
								...
								var B = P - R[0],
									...
									H =
										...
										$_(
											tb(
												(B * L + Y * j) /
													(W_(B * B + Y * Y) * W_(L * L + j * j))
											) / 2
										),
									X = W_(R[0] * R[0] + R[1] * R[1]);
								(E = V_(S, (s - X) / (H - 1))), (k = V_(S, (l - X) / (H + 1)));
							}
						}
						M > Z_
							? k > Z_
								  ...
								  k < S
										...
										: (u.arc(
										  ...
										  u.arc(
												...
												0,
												l,
												H_(y.cy + y.y11, y.cx + y.x11),
												H_(v.cy + v.y11, v.cx + v.x11),
												!g
										  ),
										  u.arc(
												v.cx,
			...
			return (
				...
				(c.endAngle = function (t) {
					return arguments.length
						? ((o = "function" == typeof t ? t : L_(+t)), c)
						: o;
				}),
				(c.padAngle = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : L_(+t)), c)
						: a;
				}),
				(c.context = function (t) {
				...
				if (i)
					if ("true" === i) i = !0;
						...
						if (
							...
							continue;
						lu && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")),
							(i = new Date(i));
					} else i = e;
				else i = null;
				t[n] = i;
		...
		(t.cluster = function () {
			...
			function i(i) {
				...
				i.eachAfter(function (n) {
					...
					e
						? ((n.x = (function (t) {
								return t.reduce(kh, 0) / t.length;
						  })(e)),
						  (n.y = (function (t) {
								return 1 + t.reduce(Nh, 0);
						  })(e)))
		...
		(t.contourDensity = function () {
			...
			function l(r) {
				...
				if (!Array.isArray(d)) {
					var p = N(i);
					(d = S(0, p, d)), (d = O(0, Math.floor(p / d) * d, d)).shift();
				}
				return pa().thresholds(d).size([c, f])(i).map(h);
			}
			function h(t) {
		...
		(t.count = c),
		(t.create = function (t) {
			return bn(st(t).call(document.documentElement));
		}),
		(t.creator = st),
		(t.cross = function (...t) {
			const n =
		...
		(t.curveBundle = em),
		(t.curveCardinal = om),
		(t.curveCardinalClosed = um),
		(t.curveCardinalOpen = fm),
		(t.curveCatmullRom = hm),
		(t.curveCatmullRomClosed = pm),
		(t.curveCatmullRomOpen = ym),
		(t.curveLinear = hb),
		...
		(t.drag = function () {
			...
			function d(a, u) {
				if (!r && i.call(this, a, u)) {
					...
					c &&
						(bn(a.view).on("mousemove.drag", p, !0).on("mouseup.drag", g, !0),
						En(a.view),
						Tn(a),
						(e = !1),
						(t = a.clientX),
			...
			function g(t) {
				bn(t.view).on("mousemove.drag mouseup.drag", null),
					kn(t.view, e),
					Sn(t),
					c.mouse("end", t);
			}
			...
			function v(t) {
				var n,
					...
					i = r.length;
				for (n = 0; n < i; ++n)
					(e = c[r[n].identifier]) && (Sn(t), e("drag", t, r[n]));
			}
			function _(t) {
				var n,
					e,
				...
				for (
					...
					(e = c[i[n].identifier]) && (Tn(t), e("end", t, i[n]));
			}
			...
			return (
				(h.filter = function (t) {
					return arguments.length
						? ((i = "function" == typeof t ? t : Nn(!!t)), h)
						: i;
				}),
				(h.container = function (t) {
					return arguments.length
						? ((o = "function" == typeof t ? t : Nn(t)), h)
						: o;
				}),
				(h.subject = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : Nn(t)), h)
						: a;
				}),
				(h.touchable = function (t) {
					return arguments.length
						? ((u = "function" == typeof t ? t : Nn(!!t)), h)
						: u;
				}),
				(h.on = function () {
		...
		(t.easeBounceInOut = function (t) {
			return ((t *= 2) <= 1 ? 1 - Gi(1 - t) : Gi(t - 1) + 1) / 2;
		}),
		(t.easeBounceOut = Gi),
		(t.easeCircle = ji),
		...
		(t.easeSinIn = function (t) {
			return 1 == +t ? 1 : 1 - Math.cos(t * Ii);
		}),
		(t.easeSinInOut = Bi),
		(t.easeSinOut = function (t) {
			return Math.sin(t * Ii);
		}),
		(t.extent = p),
		...
		(t.forceCollide = function (t) {
			...
			function a() {
				for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p)
					for (a = ku(n, qu, Ru).visitAfter(u), t = 0; t < d; ++t)
						(c = n[t]),
							(l = e[c.index]),
							(h = l * l),
							(f = c.x + c.vx),
			...
			return (
				"function" != typeof t && (t = zu(null == t ? 1 : +t)),
				...
				(a.radius = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : zu(+n)), c(), a)
						: t;
				}),
				a
			);
		...
		(t.forceLink = function (t) {
			...
			function l(r) {
				for (var i = 0, u = t.length; i < s; ++i)
					for (var c, f, l, h, d, p, g, y = 0; y < u; ++y)
						(f = (c = t[y]).source),
							(h = (l = c.target).x + l.vx - f.x - f.vx || Du(a)),
							(d = l.y + l.vy - f.y - f.vy || Du(a)),
							(h *= p =
			...
			function h() {
				if (r) {
					...
					for (a = 0, i = new Array(f); a < s; ++a)
						((c = t[a]).index = a),
							"object" != typeof c.source && (c.source = Uu(l, c.source)),
							"object" != typeof c.target && (c.target = Uu(l, c.target)),
			...
			return (
				...
				(l.strength = function (t) {
					return arguments.length
						? ((c = "function" == typeof t ? t : zu(+t)), d(), l)
						: c;
				}),
				(l.distance = function (t) {
					return arguments.length
						? ((f = "function" == typeof t ? t : zu(+t)), p(), l)
						: f;
				}),
				l
			);
		...
		(t.forceManyBody = function () {
			...
			return (
				...
				(f.strength = function (t) {
					return arguments.length
						? ((o = "function" == typeof t ? t : zu(+t)), s(), f)
						: o;
				}),
		...
		(t.forceRadial = function (t, n, e) {
			...
			return (
				...
				(u.strength = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : zu(+t)), c(), u)
						: a;
				}),
				(u.radius = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : zu(+n)), c(), u)
						: t;
				}),
				(u.x = function (t) {
		...
		(t.forceSimulation = function (t) {
			var n,
				...
				s = (function () {
					let t = 1;
					return () => (t = (1664525 * t + 1013904223) % Ou) / Ou;
				})();
			function l() {
		...
		(t.forceX = function (t) {
			...
			return (
				"function" != typeof t && (t = zu(null == t ? 0 : +t)),
				(o.initialize = function (t) {
					(n = t), a();
				}),
				(o.strength = function (t) {
					return arguments.length
						? ((i = "function" == typeof t ? t : zu(+t)), a(), o)
						: i;
				}),
				(o.x = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : zu(+n)), a(), o)
						: t;
				}),
				o
			);
		...
		(t.geoAlbersUsa = function () {
			var t,
				...
				o,
				a = oh(),
				u = ih().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
				c = ih().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
				f = {
					point: function (t, n) {
						o = [t, n];
					},
				...
				(s.translate = function (t) {
					...
					return (
						...
						(r = u
							...
							.clipExtent([
								[o - 0.425 * n + oc, s + 0.12 * n + oc],
								[o - 0.214 * n - oc, s + 0.234 * n - oc],
							])
							.stream(f)),
						(i = c
							.translate([o - 0.205 * n, s + 0.212 * n])
							.clipExtent([
								[o - 0.214 * n + oc, s + 0.166 * n + oc],
								[o - 0.115 * n - oc, s + 0.234 * n - oc],
							])
							.stream(f)),
						l()
					);
		...
		(t.geoArea = function (t) {
			return (Jc = new g()), Rc(t, tf), 2 * Jc;
		}),
		(t.geoAzimuthalEqualArea = function () {
			return th(ch).scale(124.75).clipAngle(179.999);
		}),
		(t.geoAzimuthalEqualAreaRaw = ch),
		(t.geoAzimuthalEquidistant = function () {
			return th(fh).scale(79.4188).clipAngle(179.999);
		}),
		(t.geoAzimuthalEquidistantRaw = fh),
		(t.geoBounds = function (t) {
			var n, e, r, i, o, a, u;
			if (
				((Hc = jc = -(Yc = Lc = 1 / 0)), (Zc = []), Rc(t, Nf), (e = Zc.length))
			) {
				for (Zc.sort(Of), n = 1, o = [(r = Zc[0])]; n < e; ++n)
					If(r, (i = Zc[n])[0]) || If(r, i[1])
						? (Uf(r[0], i[1]) > Uf(r[0], r[1]) && (r[1] = i[1]),
						  Uf(i[0], r[1]) > Uf(r[0], r[1]) && (r[0] = i[0]))
						: o.push((r = i));
				for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
					(i = o[n]),
						(u = Uf(r[1], i[0])) > a && ((a = u), (Yc = i[0]), (jc = r[1]));
			}
			return (
				(Zc = Kc = null),
				Yc === 1 / 0 || Lc === 1 / 0
		...
		(t.geoCircle = function () {
			var t,
				...
				o = {
					point: function (e, r) {
						t.push((e = n(e, r))), (e[0] *= lc), (e[1] *= lc);
					},
				};
			function a() {
				var a = e.apply(this, arguments),
					u = r.apply(this, arguments) * hc,
					c = i.apply(this, arguments) * hc;
				return (
					(t = []),
					(n = ts(-a[0] * hc, -a[1] * hc, 0).invert),
					os(o, u, c, 1),
			...
			return (
				(a.center = function (t) {
					return arguments.length
						? ((e = "function" == typeof t ? t : Kf([+t[0], +t[1]])), a)
						: e;
				}),
				(a.radius = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : Kf(+t)), a)
						: r;
				}),
				(a.precision = function (t) {
					return arguments.length
						? ((i = "function" == typeof t ? t : Kf(+t)), a)
						: i;
				}),
				a
			);
		}),
		(t.geoClipAntimeridian = vs),
		(t.geoClipCircle = _s),
		(t.geoClipExtent = function () {
			...
			return (e = {
				stream: function (e) {
					return t && n === e ? t : (t = Ts(r, i, o, a)((n = e)));
				},
				extent: function (u) {
					return arguments.length
						? ((r = +u[0][0]),
		...
		(t.geoClipRectangle = Ts),
		(t.geoConicConformal = function () {
			return eh(dh).scale(109.5).parallels([30, 30]);
		}),
		(t.geoConicConformalRaw = dh),
		(t.geoConicEqualArea = ih),
		(t.geoConicEqualAreaRaw = rh),
		(t.geoConicEquidistant = function () {
			return eh(gh).scale(131.154).center([0, 13.9389]);
		}),
		(t.geoConicEquidistantRaw = gh),
		(t.geoContains = function (t, n) {
			return (t && qs.hasOwnProperty(t.type) ? qs[t.type] : Fs)(t, n);
		}),
		(t.geoDistance = Ds),
		(t.geoEqualEarth = function () {
			return th(xh).scale(177.158);
		}),
		(t.geoEqualEarthRaw = xh),
		(t.geoEquirectangular = function () {
			return th(ph).scale(152.63);
		}),
		(t.geoEquirectangularRaw = ph),
		(t.geoGnomonic = function () {
			return th(wh).scale(144.049).clipAngle(60);
		}),
		(t.geoGnomonicRaw = wh),
		(t.geoGraticule = Hs),
				...
				y = p
					? function (t) {
							var n = wc((t *= p)) / g,
								...
								i = e * l + n * d,
								o = e * u + n * f;
							return [gc(i, r) * lc, gc(o, Ac(r * r + i * i)) * lc];
					  }
					: function () {
							return [e * lc, r * lc];
					  };
		...
		(t.geoMercator = function () {
			return lh(sh).scale(961 / sc);
		}),
		(t.geoMercatorRaw = sh),
		(t.geoNaturalEarth1 = function () {
			return th(Mh).scale(175.295);
		}),
		(t.geoNaturalEarth1Raw = Mh),
		(t.geoOrthographic = function () {
			return th(Ah).scale(249.5).clipAngle(90.000001);
		}),
		(t.geoOrthographicRaw = Ah),
		(t.geoPath = function (t, n) {
			...
			return (
				(o.area = function (t) {
					return Rc(t, e(Qs)), Qs.result();
				}),
				(o.measure = function (t) {
					return Rc(t, e(Ol)), Ol.result();
				}),
				(o.bounds = function (t) {
					return Rc(t, e(ul)), ul.result();
				}),
				...
				(o.projection = function (n) {
					return arguments.length
						? ((e = null == n ? ((t = null), Ws) : (t = n).stream), o)
						: t;
				}),
				(o.context = function (t) {
					return arguments.length
						? ((r = null == t ? ((n = null), new Yl()) : new Pl((n = t))),
		...
		(t.geoProjection = th),
		(t.geoProjectionMutator = nh),
		(t.geoRotation = is),
		(t.geoStereographic = function () {
			return th(Th).scale(250).clipAngle(142);
		}),
		(t.geoStereographicRaw = Th),
		(t.geoStream = Rc),
		...
		(t.interpolateArray = function (t, n) {
			return (nr(n) ? tr : er)(t, n);
		}),
		(t.interpolateBasis = je),
		(t.interpolateBasisClosed = He),
		(t.interpolateBlues = b_),
		(t.interpolateBrBG = Pv),
		(t.interpolateBuGn = Wv),
		(t.interpolateBuPu = Kv),
		...
		(t.interpolateCool = z_),
		(t.interpolateCubehelix = Er),
		(t.interpolateCubehelixDefault = C_),
		(t.interpolateCubehelixLong = kr),
		(t.interpolateDate = rr),
		...
		(t.interpolateGreens = x_),
		(t.interpolateGreys = M_),
		(t.interpolateHcl = Ar),
		(t.interpolateHclLong = Tr),
		(t.interpolateHsl = xr),
		(t.interpolateHslLong = wr),
		...
		(t.interpolateInferno = B_),
		(t.interpolateLab = function (t, n) {
			var e = We((t = xe(t)).l, (n = xe(n)).l),
				r = We(t.a, n.a),
				i = We(t.b, n.b),
				o = We(t.opacity, n.opacity);
			return function (n) {
				return (
		...
		(t.interpolateMagma = I_),
		(t.interpolateNumber = ir),
		(t.interpolateNumberArray = tr),
		(t.interpolateObject = or),
		(t.interpolateOrRd = n_),
		(t.interpolateOranges = N_),
		(t.interpolatePRGn = Dv),
		(t.interpolatePiYG = Rv),
		(t.interpolatePlasma = Y_),
		(t.interpolatePuBu = o_),
		(t.interpolatePuBuGn = r_),
		(t.interpolatePuOr = Uv),
		(t.interpolatePuRd = u_),
		...
		(t.interpolateRdBu = Iv),
		(t.interpolateRdGy = Yv),
		(t.interpolateRdPu = f_),
		(t.interpolateRdYlBu = jv),
		(t.interpolateRdYlGn = Xv),
		(t.interpolateReds = E_),
		(t.interpolateRgb = Ze),
		(t.interpolateRgbBasis = Qe),
		(t.interpolateRgbBasisClosed = Je),
		(t.interpolateRound = sr),
		(t.interpolateSinebow = function (t) {
			var n;
			return (
				(t = (0.5 - t) * Math.PI),
				(q_.r = 255 * (n = Math.sin(t)) * n),
				(q_.g = 255 * (n = Math.sin(t + R_)) * n),
				(q_.b = 255 * (n = Math.sin(t + F_)) * n),
				q_ + ""
			);
		}),
		(t.interpolateSpectral = Vv),
		(t.interpolateString = cr),
		(t.interpolateTransformCss = yr),
		(t.interpolateTransformSvg = vr),
		...
		(t.interpolateViridis = O_),
		(t.interpolateWarm = P_),
		(t.interpolateYlGn = d_),
		(t.interpolateYlGnBu = l_),
		(t.interpolateYlOrBr = g_),
		(t.interpolateYlOrRd = v_),
		...
		(t.pack = function () {
			...
			function i(i) {
				return (
					...
					(i.y = e / 2),
					t
						? i.eachBefore(nd(t)).eachAfter(ed(r, 0.5)).eachBefore(rd(1))
						: i
								.eachBefore(nd(td))
								.eachAfter(ed(Qh, 1))
								.eachAfter(ed(r, i.r / Math.min(n, e)))
			...
			return (
				(i.radius = function (n) {
					return arguments.length ? ((t = Zh(n)), i) : t;
				}),
				(i.size = function (t) {
		...
		(t.pie = function () {
			...
			function a(a) {
				var u,
					...
					v = Math.min(J_, Math.max(-J_, i.apply(this, arguments) - y)),
		...
		(t.precisionFixed = ec),
		(t.precisionPrefix = rc),
		(t.precisionRound = ic),
		(t.quadtree = ku),
		(t.quantile = D),
		(t.quantileSorted = function (t, n, e = r) {
			if ((i = t.length)) {
		...
		(t.radialLine = Mb),
		(t.randomBates = Cd),
		(t.randomBernoulli = Dd),
		(t.randomBeta = Fd),
		(t.randomBinomial = Ud),
		(t.randomCauchy = Id),
		(t.randomExponential = Pd),
		(t.randomGamma = Rd),
		(t.randomGeometric = qd),
		(t.randomInt = Sd),
		(t.randomIrwinHall = Nd),
		(t.randomLcg = function (t = Math.random()) {
			let n = 0 | (0 <= t && t < 1 ? t / Ld : Math.abs(t));
			return () => ((n = (1664525 * n + 1013904223) | 0), Ld * (n >>> 0));
		}),
		(t.randomLogNormal = kd),
		(t.randomLogistic = Bd),
		(t.randomNormal = Ed),
		(t.randomPareto = zd),
		(t.randomPoisson = Yd),
		...
		(t.scaleDiverging = function t() {
			...
			return (
				...
				Hd.apply(n, arguments)
			);
		}),
		(t.scaleDivergingLog = function t() {
			var n = dp(yv()).domain([0.1, 1, 10]);
			return (
				(n.copy = function () {
					return pv(n, t()).base(n.base());
				}),
				Hd.apply(n, arguments)
			);
		}),
		(t.scaleDivergingPow = vv),
		...
		(t.scaleDivergingSymlog = function t() {
			...
			return (
				(n.copy = function () {
					return pv(n, t()).constant(n.constant());
				}),
				Hd.apply(n, arguments)
			);
		}),
		(t.scaleIdentity = function t(n) {
			...
			return (
				...
				(r.domain = r.range = function (t) {
					return arguments.length ? ((n = Array.from(t, Wd)), r) : n.slice();
				}),
				...
				(n = arguments.length ? Array.from(n, Wd) : [0, 1]),
				op(r)
			);
		}),
		(t.scaleImplicit = Xd),
		(t.scaleLinear = function t() {
			...
			return (
				...
				jd.apply(n, arguments),
				op(n)
			);
		}),
		(t.scaleLog = function t() {
			var n = dp(ep()).domain([1, 10]);
			return (
				(n.copy = function () {
					return np(n, t()).base(n.base());
				}),
				jd.apply(n, arguments),
				n
			);
		...
		(t.scalePoint = function () {
			return $d(Vd.apply(null, arguments).paddingInner(1));
		}),
		(t.scalePow = xp),
		...
		(t.scaleRadial = function t() {
			...
			return (
				...
				(o.range = function (t) {
					return arguments.length
						? (e.range((r = Array.from(t, Wd)).map(wp)), o)
						: r.slice();
				}),
		...
		(t.scaleSymlog = function t() {
			...
			return (
				(n.copy = function () {
					return np(n, t()).constant(n.constant());
				}),
				jd.apply(n, arguments)
			);
		}),
		(t.scaleThreshold = function t() {
			...
			return (
				...
				jd.apply(a, arguments)
			);
		}),
		(t.scaleTime = function () {
			return jd.apply(
				hv(og, rg, jp, Bp, Op, Fp, qp, Ep, t.timeFormat).domain([
					new Date(2e3, 0, 1),
					new Date(2e3, 0, 2),
				]),
				arguments
		...
		(t.scaleUtc = function () {
			return jd.apply(
				hv(Cg, kg, pg, lg, fg, ug, qp, Ep, t.utcFormat).domain([
					Date.UTC(2e3, 0, 1),
					Date.UTC(2e3, 0, 2),
				]),
				arguments
		...
		(t.stack = function () {
			...
			function i(i) {
				var o,
					a,
					u = Array.from(t.apply(this, arguments), Pm),
					c = u.length,
					f = -1;
				for (const t of i)
					for (o = 0, ++f; o < c; ++o)
						(u[o][f] = [0, +r(t, u[o].key, f, i)]).data = t;
				for (o = 0, a = sb(n(u)); o < c; ++o) u[a[o]].index = o;
				return e(u, a), u;
			}
			return (
				(i.keys = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : L_(Array.from(n))), i)
						: t;
				}),
				(i.value = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : L_(+t)), i)
						: r;
				}),
				(i.order = function (t) {
					return arguments.length
				...
				(i.offset = function (t) {
					return arguments.length ? ((e = null == t ? km : t), i) : e;
				}),
				i
			);
		}),
		...
		(t.stackOffsetWiggle = function (t, n) {
			if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
				...
				(e[a - 1][1] += e[a - 1][0] = o), km(t, n);
			}
		}),
		(t.stackOrderAppearance = zm),
		(t.stackOrderAscending = qm),
		...
		(t.stratify = function () {
			...
			return (
				(e.id = function (n) {
					return arguments.length ? ((t = Kh(n)), e) : t;
				}),
				(e.parentId = function (t) {
					return arguments.length ? ((n = Kh(t)), e) : n;
				}),
				e
			);
		}),
		...
		(t.symbol = function (t, n) {
			...
			return (
				(t = "function" == typeof t ? t : L_(t || zb)),
				(n = "function" == typeof n ? n : L_(void 0 === n ? 64 : +n)),
				(r.type = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : L_(n)), r)
						: t;
				}),
				(r.size = function (t) {
					return arguments.length
						? ((n = "function" == typeof t ? t : L_(+t)), r)
						: n;
				}),
		...
		(t.timeFormatLocale = Rg),
		(t.timeFriday = $p),
		(t.timeFridays = ng),
		(t.timeHour = Op),
		(t.timeHours = Ip),
		(t.timeInterval = Sp),
		(t.timeMillisecond = Ep),
		(t.timeMilliseconds = kp),
		(t.timeMinute = Fp),
		(t.timeMinutes = Up),
		(t.timeMonday = Hp),
		(t.timeMondays = Kp),
		...
		(t.tree = function () {
			...
			function i(i) {
				var c = (function (t) {
					for (var n, e, r, i, o, a = new gd(t, 0), u = [a]; (n = u.pop()); )
						if ((r = n._.children))
							for (
								...
								u.push((e = n.children[i] = new gd(r[i], i))), (e.parent = n);
					return ((a.parent = new gd(null, 0)).children = [a]), a;
				})(i);
						...
						for (
							...
							(c = ld(c)),
								...
								(i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
									(dd(pd(u, n, r), n, i), (f += i), (s += i)),
								(l += u.m),
								(f += o.m),
								(h += c.m),
								(s += a.m);
						u && !hd(a) && ((a.t = u), (a.m += l - s)),
							o && !ld(c) && ((c.t = o), (c.m += f - h), (r = n));
					}
					return r;
				})(n, i, n.parent.A || r[0]);
			}
		...
		(t.treemap = function () {
			...
			return (
				...
				(s.tile = function (n) {
					return arguments.length ? ((t = Kh(n)), s) : t;
				}),
				...
				(s.paddingTop = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : Jh(+t)), s)
						: a;
				}),
				(s.paddingRight = function (t) {
					return arguments.length
						? ((u = "function" == typeof t ? t : Jh(+t)), s)
						: u;
				}),
				(s.paddingBottom = function (t) {
					return arguments.length
						? ((c = "function" == typeof t ? t : Jh(+t)), s)
						: c;
				}),
				(s.paddingLeft = function (t) {
					return arguments.length
						? ((f = "function" == typeof t ? t : Jh(+t)), s)
						: f;
				}),
				s
			);
		...
		(t.treemapDice = od),
		(t.treemapResquarify = md),
		(t.treemapSlice = yd),
		(t.treemapSliceDice = function (t, n, e, r, i) {
			(1 & t.depth ? yd : od)(t, n, e, r, i);
		}),
		(t.treemapSquarify = bd),
		(t.tsv = _u),
		(t.tsvFormat = au),
		(t.tsvFormatBody = uu),
		(t.tsvFormatRow = fu),
		...
		(t.zoom = function () {
			...
			function _(t, n, e) {
				var r = n[0] - e[0] * t.k,
					i = n[1] - e[1] * t.k;
				return r === t.x && i === t.y ? t : new Om(t.k, r, i);
			}
			function b(t) {
					...
					.tween("zoom", function () {
						...
						return function (t) {
							if (1 === t) t = h;
								...
								var n = d(t),
									e = f / n[2];
								t = new Om(e, c[0] - n[0] * e, c[1] - n[1] * e);
							}
							a.zoom(null, t);
						};
					});
			...
			function M(t, ...n) {
				if (r.apply(this, arguments)) {
					...
					if (e.wheel)
						...
						if (i.k === u) return;
						(e.mouse = [s, i.invert(s)]), ni(this), e.start();
					}
					Lm(t),
			...
			function A(t, ...n) {
				...
				function h(t) {
					...
					i.event(t).zoom(
						"mouse",
						o(
							_(i.that.__zoom, (i.mouse[0] = An(t, c)), i.mouse[1]),
							i.extent,
							f
						)
					);
			...
			function T(t, ...n) {
				if (r.apply(this, arguments)) {
					var e = this.__zoom,
						a = An(t.changedTouches ? t.changedTouches[0] : t, this),
						u = e.invert(a),
						c = e.k * (t.shiftKey ? 0.5 : 2),
						l = o(_(v(e, c), a, u), i.apply(this, n), f);
					Lm(t),
						s > 0
							? bn(this).transition().duration(s).call(m, l, a, t)
							: bn(this).call(y.transform, l, a, t);
				}
			}
			function S(e, ...i) {
				if (r.apply(this, arguments)) {
			...
			function k(t, ...r) {
				if (this.__zooming) {
					...
					if (
						...
						(a.end(),
						2 === a.taps &&
							((o = An(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
					) {
			...
			return (
				...
				(y.wheelDelta = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : Fm(+t)), y)
						: a;
				}),
				(y.filter = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : Fm(!!t)), y)
						: r;
				}),
				(y.touchable = function (t) {
					return arguments.length
						? ((u = "function" == typeof t ? t : Fm(!!t)), y)
						: u;
				}),
				(y.extent = function (t) {
					return arguments.length
